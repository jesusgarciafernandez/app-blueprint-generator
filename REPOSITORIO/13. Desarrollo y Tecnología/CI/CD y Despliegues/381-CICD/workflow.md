...
subcategory: General
tags: ['ci', 'cd', 'pipelines', 'automation', 'devops', 'deployment', 'github-actions', 'jenkins', 'delivery']
...
# 🚀 Estrategia de Automatización: CICD

Este documento define las tres vías posibles para implementar la skill de CICD en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de CICD"""
    print(f"Iniciando flujo técnico para: CICD")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "CICD"}
...
**REST Endpoint:** `POST /v1/automate/381`
