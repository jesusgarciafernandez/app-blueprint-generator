---
title: Master Workflow: Contenedores (Docker)
version: 1.1
...
subcategory: General
tags: ['docker', 'containers', 'containerization', 'devops', 'microservices', 'docker-compose', 'image-optimization', 'layer-caching']
...
# 🚀 Estrategia de Automatización: Contenedores (Docker)

Este documento define las tres vías posibles para implementar la skill de Contenedores (Docker) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Contenedores (Docker)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Contenedores (Docker)"""
    print(f"Iniciando flujo técnico para: Contenedores (Docker)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Contenedores (Docker)"}
...
**REST Endpoint:** `POST /v1/automate/382`
