---
title: Master Workflow: Testing Automatizado
version: 1.1
...
subcategory: General
tags: ['testing', 'automation', 'qa', 'jest', 'cypress', 'playwright', 'unit-testing', 'e2e', 'tdd']
...
# 🚀 Estrategia de Automatización: Testing Automatizado

Este documento define las tres vías posibles para implementar la skill de Testing Automatizado en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Testing Automatizado",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Testing Automatizado"""
    print(f"Iniciando flujo técnico para: Testing Automatizado")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Testing Automatizado"}
...
**REST Endpoint:** `POST /v1/automate/386`
