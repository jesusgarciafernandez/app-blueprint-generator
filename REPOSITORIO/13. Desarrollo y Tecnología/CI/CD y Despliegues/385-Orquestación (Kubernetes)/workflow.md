---
title: Master Workflow: Orquestación (Kubernetes)
version: 1.1
...
# 🚀 Estrategia de Automatización: Orquestación (Kubernetes)

Este documento define las tres vías posibles para implementar la skill de Orquestación (Kubernetes) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Orquestación (Kubernetes)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Orquestación (Kubernetes)"""
    print(f"Iniciando flujo técnico para: Orquestación (Kubernetes)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Orquestación (Kubernetes)"}
...
**REST Endpoint:** `POST /v1/automate/385`
