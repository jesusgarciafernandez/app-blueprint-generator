---
title: Master Workflow: Prototipado de Hardware
version: 1.1
...
subcategory: General
tags: ['hardware-prototyping', '3d-printing', 'arduino', 'raspberry-pi', 'cad-design', 'iot-devices', 'industrial-design']
...
# 🚀 Estrategia de Automatización: Prototipado de Hardware

Este documento define las tres vías posibles para implementar la skill de Prototipado de Hardware en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Prototipado de Hardware",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Prototipado de Hardware"""
    print(f"Iniciando flujo técnico para: Prototipado de Hardware")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Prototipado de Hardware"}
...
**REST Endpoint:** `POST /v1/automate/402`
