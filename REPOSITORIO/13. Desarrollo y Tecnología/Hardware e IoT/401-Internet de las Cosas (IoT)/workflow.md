---
title: Master Workflow: Internet de las Cosas (IoT)
version: 1.1
...
subcategory: General
tags: ['iot', 'arduino', 'raspberry-pi', 'esp32', 'mqtt', 'sensors', 'embedded-systems', 'edge-computing']
...
# 🚀 Estrategia de Automatización: Internet de las Cosas (IoT)

Este documento define las tres vías posibles para implementar la skill de Internet de las Cosas (IoT) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Internet de las Cosas (IoT)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Internet de las Cosas (IoT)"""
    print(f"Iniciando flujo técnico para: Internet de las Cosas (IoT)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Internet de las Cosas (IoT)"}
...
**REST Endpoint:** `POST /v1/automate/401`
