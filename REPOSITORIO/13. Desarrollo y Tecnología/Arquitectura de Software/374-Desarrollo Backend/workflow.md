---
title: Master Workflow: Desarrollo Backend
version: 1.1
...
subcategory: General
tags: ['backend', 'nodejs', 'go', 'python', 'architecture', 'database', 'security', 'scalability']
...
# 🚀 Estrategia de Automatización: Desarrollo Backend

Este documento define las tres vías posibles para implementar la skill de Desarrollo Backend en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Desarrollo Backend",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Desarrollo Backend"""
    print(f"Iniciando flujo técnico para: Desarrollo Backend")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Desarrollo Backend"}
...
**REST Endpoint:** `POST /v1/automate/374`
