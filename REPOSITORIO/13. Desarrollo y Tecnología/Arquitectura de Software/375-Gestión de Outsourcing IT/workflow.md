---
title: Master Workflow: Gestión de Outsourcing IT
version: 1.1
...
subcategory: General
tags: ['it-outsourcing', 'vendor-management', 'remote-teams', 'offshoring', 'nearshoring', 'software-delivery', 'sla-monitoring', 'resource-augmentation']
...
# 🚀 Estrategia de Automatización: Gestión de Outsourcing IT

Este documento define las tres vías posibles para implementar la skill de Gestión de Outsourcing IT en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de Outsourcing IT",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de Outsourcing IT"""
    print(f"Iniciando flujo técnico para: Gestión de Outsourcing IT")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de Outsourcing IT"}
...
**REST Endpoint:** `POST /v1/automate/375`
