---
title: Master Workflow: Gestión de Bases de Datos SQL
version: 1.1
...
subcategory: General
tags: ['sql', 'postgresql', 'mysql', 'database-design', 'acid', 'optimization', 'query-tuning', 'normalization']
...
# 🚀 Estrategia de Automatización: Gestión de Bases de Datos SQL

Este documento define las tres vías posibles para implementar la skill de Gestión de Bases de Datos SQL en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de Bases de Datos SQL",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de Bases de Datos SQL"""
    print(f"Iniciando flujo técnico para: Gestión de Bases de Datos SQL")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de Bases de Datos SQL"}
...
**REST Endpoint:** `POST /v1/automate/379`
