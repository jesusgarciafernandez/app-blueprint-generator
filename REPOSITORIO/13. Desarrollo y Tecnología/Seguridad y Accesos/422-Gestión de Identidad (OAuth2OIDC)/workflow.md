---
title: Master Workflow: Gestión de Identidad (OAuth2OIDC)
version: 1.1
...
# 🚀 Estrategia de Automatización: Gestión de Identidad (OAuth2OIDC)

Este documento define las tres vías posibles para implementar la skill de Gestión de Identidad (OAuth2OIDC) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de Identidad (OAuth2OIDC)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de Identidad (OAuth2OIDC)"""
    print(f"Iniciando flujo técnico para: Gestión de Identidad (OAuth2OIDC)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de Identidad (OAuth2OIDC)"}
...
**REST Endpoint:** `POST /v1/automate/422`
