---
title: Master Workflow: Ciberseguridad Defensiva
version: 1.1
...
subcategory: General
tags: ['cybersecurity', 'defensive', 'secops', 'blue-team', 'firewall', 'siem', 'soc', 'threat-intelligence']
...
# 🚀 Estrategia de Automatización: Ciberseguridad Defensiva

Este documento define las tres vías posibles para implementar la skill de Ciberseguridad Defensiva en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Ciberseguridad Defensiva",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Ciberseguridad Defensiva"""
    print(f"Iniciando flujo técnico para: Ciberseguridad Defensiva")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Ciberseguridad Defensiva"}
...
**REST Endpoint:** `POST /v1/automate/420`
