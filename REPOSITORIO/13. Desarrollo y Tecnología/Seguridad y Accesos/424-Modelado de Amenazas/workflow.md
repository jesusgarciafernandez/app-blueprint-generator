---
title: Master Workflow: Modelado de Amenazas
version: 1.1
...
subcategory: General
tags: ['threat-modeling', 'cybersecurity', 'stride', 'security-by-design', 'risk-assessment', 'devsecops', 'hacking-etico', 'mitre-att&ck']
...
# 🚀 Estrategia de Automatización: Modelado de Amenazas

Este documento define las tres vías posibles para implementar la skill de Modelado de Amenazas en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Modelado de Amenazas",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Modelado de Amenazas"""
    print(f"Iniciando flujo técnico para: Modelado de Amenazas")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Modelado de Amenazas"}
...
**REST Endpoint:** `POST /v1/automate/424`
