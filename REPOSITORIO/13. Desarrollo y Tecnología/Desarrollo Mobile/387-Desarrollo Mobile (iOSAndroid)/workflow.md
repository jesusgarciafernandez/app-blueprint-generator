---
title: Master Workflow: Desarrollo Mobile (iOSAndroid)
version: 1.1
...
subcategory: General
tags: ['mobile', 'ios', 'android', 'react-native', 'flutter', 'swift', 'kotlin', 'ui-ux']
...
# 🚀 Estrategia de Automatización: Desarrollo Mobile (iOSAndroid)

Este documento define las tres vías posibles para implementar la skill de Desarrollo Mobile (iOSAndroid) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Desarrollo Mobile (iOSAndroid)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Desarrollo Mobile (iOSAndroid)"""
    print(f"Iniciando flujo técnico para: Desarrollo Mobile (iOSAndroid)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Desarrollo Mobile (iOSAndroid)"}
...
**REST Endpoint:** `POST /v1/automate/387`
