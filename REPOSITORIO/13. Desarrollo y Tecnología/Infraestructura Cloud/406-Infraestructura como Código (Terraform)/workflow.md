---
title: Master Workflow: Infraestructura como Código (Terraform)
version: 1.1
...
subcategory: General
tags: ['terraform', 'iac', 'cloud-infrastructure', 'hcl', 'provisioning', 'automation', 'devops']
...
# 🚀 Estrategia de Automatización: Infraestructura como Código (Terraform)

Este documento define las tres vías posibles para implementar la skill de Infraestructura como Código (Terraform) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Infraestructura como Código (Terraform)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Infraestructura como Código (Terraform)"""
    print(f"Iniciando flujo técnico para: Infraestructura como Código (Terraform)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Infraestructura como Código (Terraform)"}
...
**REST Endpoint:** `POST /v1/automate/406`
