---
title: Master Workflow: Exploración Espacial Sostenible
version: 1.1
...
subcategory: General
tags: ['space-sustainability', 'orbital-debris-management', 'kessler-syndrome-prevention', 'circular-space-economy', 'satellite-servicing', 'space-traffic-management', 'sustainable-propulsion', 'planetary-protection']
...
# 🚀 Estrategia de Automatización: Exploración Espacial Sostenible

Este documento define las tres vías posibles para implementar la skill de Exploración Espacial Sostenible en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Exploración Espacial Sostenible",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Exploración Espacial Sostenible"""
    print(f"Iniciando flujo técnico para: Exploración Espacial Sostenible")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Exploración Espacial Sostenible"}
...
**REST Endpoint:** `POST /v1/automate/397`
