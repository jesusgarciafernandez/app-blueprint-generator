---
title: Master Workflow: Progressive Web Apps (PWA)
version: 1.1
...
subcategory: General
tags: ['pwa', 'service-worker', 'offline-first', 'web-app-manifest', 'push-notifications', 'performance', 'frontend']
...
# 🚀 Estrategia de Automatización: Progressive Web Apps (PWA)

Este documento define las tres vías posibles para implementar la skill de Progressive Web Apps (PWA) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Progressive Web Apps (PWA)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Progressive Web Apps (PWA)"""
    print(f"Iniciando flujo técnico para: Progressive Web Apps (PWA)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Progressive Web Apps (PWA)"}
...
**REST Endpoint:** `POST /v1/automate/393`
