---
title: Master Workflow: Server-Side Rendering (SSR)
version: 1.1
...
subcategory: General
tags: ['ssr', 'nextjs', 'seo', 'web-performance', 'frontend', 'hydration', 'react', 'vue', 'node.js']
...
# 🚀 Estrategia de Automatización: Server-Side Rendering (SSR)

Este documento define las tres vías posibles para implementar la skill de Server-Side Rendering (SSR) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Server-Side Rendering (SSR)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Server-Side Rendering (SSR)"""
    print(f"Iniciando flujo técnico para: Server-Side Rendering (SSR)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Server-Side Rendering (SSR)"}
...
**REST Endpoint:** `POST /v1/automate/394`
