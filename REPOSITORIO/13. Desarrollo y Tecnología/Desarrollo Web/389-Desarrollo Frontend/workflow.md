---
title: Master Workflow: Desarrollo Frontend
version: 1.1
...
subcategory: General
tags: ['frontend', 'react', 'nextjs', 'javascript', 'typescript', 'ui-ux', 'web-performance', 'web-components']
...
# 🚀 Estrategia de Automatización: Desarrollo Frontend

Este documento define las tres vías posibles para implementar la skill de Desarrollo Frontend en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Desarrollo Frontend",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Desarrollo Frontend"""
    print(f"Iniciando flujo técnico para: Desarrollo Frontend")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Desarrollo Frontend"}
...
**REST Endpoint:** `POST /v1/automate/389`
