---
title: Master Workflow: Low-code  No-code
version: 1.1
...
subcategory: General
tags: ['nocode', 'lowcode', 'bubble', 'flutterflow', 'softr', 'airtable', 'zapier', 'make', 'rapid-prototyping']
...
# 🚀 Estrategia de Automatización: Low-code  No-code

Este documento define las tres vías posibles para implementar la skill de Low-code  No-code en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Low-code  No-code"""
    print(f"Iniciando flujo técnico para: Low-code  No-code")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Low-code  No-code"}
...
**REST Endpoint:** `POST /v1/automate/391`
