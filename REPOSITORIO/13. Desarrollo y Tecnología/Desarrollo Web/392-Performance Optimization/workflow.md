---
title: Master Workflow: Performance Optimization
version: 1.1
...
subcategory: General
tags: ['performance', 'web-vitals', 'optimization', 'latency', 'caching', 'cdn', 'rendering', 'lighthouse']
...
# 🚀 Estrategia de Automatización: Performance Optimization

Este documento define las tres vías posibles para implementar la skill de Performance Optimization en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Performance Optimization",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Performance Optimization"""
    print(f"Iniciando flujo técnico para: Performance Optimization")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Performance Optimization"}
...
**REST Endpoint:** `POST /v1/automate/392`
