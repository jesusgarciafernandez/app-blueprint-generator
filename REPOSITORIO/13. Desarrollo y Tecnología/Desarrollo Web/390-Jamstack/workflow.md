---
title: Master Workflow: Jamstack
version: 1.1
...
subcategory: General
tags: ['jamstack', 'static-site-generator', 'headless-cms', 'apis', 'performance', 'security', 'serverless', 'netlify', 'vercel']
...
# 🚀 Estrategia de Automatización: Jamstack

Este documento define las tres vías posibles para implementar la skill de Jamstack en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Jamstack"""
    print(f"Iniciando flujo técnico para: Jamstack")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Jamstack"}
...
**REST Endpoint:** `POST /v1/automate/390`
