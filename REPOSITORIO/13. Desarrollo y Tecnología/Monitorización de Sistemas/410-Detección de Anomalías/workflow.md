---
title: Master Workflow: Detección de Anomalías
version: 1.1
...
# 🚀 Estrategia de Automatización: Detección de Anomalías

Este documento define las tres vías posibles para implementar la skill de Detección de Anomalías en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Detección de Anomalías",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Detección de Anomalías"""
    print(f"Iniciando flujo técnico para: Detección de Anomalías")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Detección de Anomalías"}
...
**REST Endpoint:** `POST /v1/automate/410`
