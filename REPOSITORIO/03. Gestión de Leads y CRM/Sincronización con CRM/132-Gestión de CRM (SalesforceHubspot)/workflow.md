---
title: Master Workflow: Gestión de CRM (SalesforceHubspot)
version: 1.1
...
# 🚀 Estrategia de Automatización: Gestión de CRM (SalesforceHubspot)

Este documento define las tres vías posibles para implementar la skill de Gestión de CRM (SalesforceHubspot) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de CRM (SalesforceHubspot)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de CRM (SalesforceHubspot)"""
    print(f"Iniciando flujo técnico para: Gestión de CRM (SalesforceHubspot)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de CRM (SalesforceHubspot)"}
...
**REST Endpoint:** `POST /v1/automate/132`
