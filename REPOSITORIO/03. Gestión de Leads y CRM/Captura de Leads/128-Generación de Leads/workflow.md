---
title: Master Workflow: Generación de Leads
version: 1.1
...
# 🚀 Estrategia de Automatización: Generación de Leads

Este documento define las tres vías posibles para implementar la skill de Generación de Leads en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Generación de Leads",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Generación de Leads"""
    print(f"Iniciando flujo técnico para: Generación de Leads")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Generación de Leads"}
...
**REST Endpoint:** `POST /v1/automate/128`
