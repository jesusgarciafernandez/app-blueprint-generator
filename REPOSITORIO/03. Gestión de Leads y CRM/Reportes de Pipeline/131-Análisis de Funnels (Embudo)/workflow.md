---
title: Master Workflow: Análisis de Funnels (Embudo)
version: 1.1
...
subcategory: General
tags: ['funnel-analysis', 'conversion-optimization', 'aarrr', 'cro', 'customer-journey']
...
# 🚀 Estrategia de Automatización: Análisis de Funnels (Embudo)

Este documento define las tres vías posibles para implementar la skill de Análisis de Funnels (Embudo) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Análisis de Funnels (Embudo)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Análisis de Funnels (Embudo)"""
    print(f"Iniciando flujo técnico para: Análisis de Funnels (Embudo)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Análisis de Funnels (Embudo)"}
...
**REST Endpoint:** `POST /v1/automate/131`
