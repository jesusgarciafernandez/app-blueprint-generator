---
title: Master Workflow: Strategic Outsourcing
version: 1.1
...
# 🚀 Estrategia de Automatización: Strategic Outsourcing

Este documento define las tres vías posibles para implementar la skill de Strategic Outsourcing en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Strategic Outsourcing",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Strategic Outsourcing"""
    print(f"Iniciando flujo técnico para: Strategic Outsourcing")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Strategic Outsourcing"}
...
**REST Endpoint:** `POST /v1/automate/513`
