---
title: Master Workflow: Gestión de Proveedores (Sourcing)
version: 1.1
...
subcategory: General
tags: ['sourcing', 'procurement', 'vendor-management', 'supply-chain', 'negotiation', 'rfp', 'strategic-sourcing', 'vendor-audit']
...
# 🚀 Estrategia de Automatización: Gestión de Proveedores (Sourcing)

Este documento define las tres vías posibles para implementar la skill de Gestión de Proveedores (Sourcing) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de Proveedores (Sourcing)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de Proveedores (Sourcing)"""
    print(f"Iniciando flujo técnico para: Gestión de Proveedores (Sourcing)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de Proveedores (Sourcing)"}
...
**REST Endpoint:** `POST /v1/automate/510`
