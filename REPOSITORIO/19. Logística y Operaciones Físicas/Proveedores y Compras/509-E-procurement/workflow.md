---
title: Master Workflow: E-procurement
version: 1.1
...
subcategory: General
tags: ['e-procurement', 'digital-purchasing', 'spend-management', 'supplier-portals', 'procure-to-pay', 'p2p-process', 'strategic-sourcing', 'cost-control']
...
# 🚀 Estrategia de Automatización: E-procurement

Este documento define las tres vías posibles para implementar la skill de E-procurement en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de E-procurement"""
    print(f"Iniciando flujo técnico para: E-procurement")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "E-procurement"}
...
**REST Endpoint:** `POST /v1/automate/509`
