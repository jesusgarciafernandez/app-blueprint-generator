---
title: Master Workflow: Gestión de la Cadena de Frío
version: 1.1
...
subcategory: General
tags: ['cold-chain', 'thermal-logistics', 'perishable-goods', 'pharma-logistics', 'temperature-control', 'iot-tracking', 'gdp-compliance', 'supply-chain']
...
# 🚀 Estrategia de Automatización: Gestión de la Cadena de Frío

Este documento define las tres vías posibles para implementar la skill de Gestión de la Cadena de Frío en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de la Cadena de Frío",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de la Cadena de Frío"""
    print(f"Iniciando flujo técnico para: Gestión de la Cadena de Frío")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de la Cadena de Frío"}
...
**REST Endpoint:** `POST /v1/automate/515`
