---
title: Master Workflow: Gestión de Aduanas
version: 1.1
...
subcategory: General
tags: ['customs-management', 'import-export', 'tariffs', 'tax-compliance', 'international-trade', 'border-clearance', 'logistics-ops', 'regulatory-compliance']
...
# 🚀 Estrategia de Automatización: Gestión de Aduanas

Este documento define las tres vías posibles para implementar la skill de Gestión de Aduanas en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de Aduanas",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de Aduanas"""
    print(f"Iniciando flujo técnico para: Gestión de Aduanas")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de Aduanas"}
...
**REST Endpoint:** `POST /v1/automate/514`
