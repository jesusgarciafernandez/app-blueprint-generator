---
title: Master Workflow: Gestión de Garantías y Devoluciones
version: 1.1
...
subcategory: General
tags: ['warranty-management', 'reverse-logistics', 'returns-processing', 'customer-service-ops', 'refund-policy', 'rmat-management', 'product-repair', 'quality-control']
...
# 🚀 Estrategia de Automatización: Gestión de Garantías y Devoluciones

Este documento define las tres vías posibles para implementar la skill de Gestión de Garantías y Devoluciones en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de Garantías y Devoluciones",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de Garantías y Devoluciones"""
    print(f"Iniciando flujo técnico para: Gestión de Garantías y Devoluciones")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de Garantías y Devoluciones"}
...
**REST Endpoint:** `POST /v1/automate/502`
