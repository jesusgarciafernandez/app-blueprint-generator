---
title: Master Workflow: Calculadora de Costes y Escandallos de Hostelería
version: 1.1
...
subcategory: General
tags: [hospitality, calc, costs, margin]
...
# 🚀 Estrategia de Automatización: Calculadora de Costes y Escandallos de Hostelería

Este documento define las tres vías posibles para implementar la skill de Calculadora de Costes y Escandallos de Hostelería en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Calculadora de Costes y Escandallos de Hostelería",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Calculadora de Costes y Escandallos de Hostelería"""
    print(f"Iniciando flujo técnico para: Calculadora de Costes y Escandallos de Hostelería")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Calculadora de Costes y Escandallos de Hostelería"}
...
**REST Endpoint:** `POST /v1/automate/501`
