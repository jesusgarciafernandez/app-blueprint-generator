---
title: Master Workflow: Gestión de la Calidad (Six Sigma)
version: 1.1
...
subcategory: General
tags: ['six-sigma', 'lean-manufacturing', 'quality-assurance', 'dmaic', 'process-control', 'statistical-analysis', 'kaizen', 'quality-management']
...
# 🚀 Estrategia de Automatización: Gestión de la Calidad (Six Sigma)

Este documento define las tres vías posibles para implementar la skill de Gestión de la Calidad (Six Sigma) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de la Calidad (Six Sigma)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de la Calidad (Six Sigma)"""
    print(f"Iniciando flujo técnico para: Gestión de la Calidad (Six Sigma)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de la Calidad (Six Sigma)"}
...
**REST Endpoint:** `POST /v1/automate/507`
