---
title: Master Workflow: Gestión de Calidad (ISOEstándares)
version: 1.1
...
subcategory: General
tags: ['quality-management', 'iso-9001', 'total-quality', 'kaizen', 'process-optimization', 'compliance', 'standardization']
...
# 🚀 Estrategia de Automatización: Gestión de Calidad (ISOEstándares)

Este documento define las tres vías posibles para implementar la skill de Gestión de Calidad (ISOEstándares) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de Calidad (ISOEstándares)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de Calidad (ISOEstándares)"""
    print(f"Iniciando flujo técnico para: Gestión de Calidad (ISOEstándares)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de Calidad (ISOEstándares)"}
...
**REST Endpoint:** `POST /v1/automate/505`
