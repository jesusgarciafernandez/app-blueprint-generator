---
title: Master Workflow: Pensamiento Crítico en Liderazgo
version: 1.1
...
subcategory: General
tags: ['critical-thinking', 'logic', 'mental-models', 'decision-making', 'cognitive-biases', 'problem-solving', 'first-principles', 'rationality']
...
# 🚀 Estrategia de Automatización: Pensamiento Crítico en Liderazgo

Este documento define las tres vías posibles para implementar la skill de Pensamiento Crítico en Liderazgo en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Pensamiento Crítico en Liderazgo",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Pensamiento Crítico en Liderazgo"""
    print(f"Iniciando flujo técnico para: Pensamiento Crítico en Liderazgo")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Pensamiento Crítico en Liderazgo"}
...
**REST Endpoint:** `POST /v1/automate/323`
