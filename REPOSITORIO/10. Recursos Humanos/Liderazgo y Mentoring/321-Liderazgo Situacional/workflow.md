---
title: Master Workflow: Liderazgo Situacional
version: 1.1
...
# 🚀 Estrategia de Automatización: Liderazgo Situacional

Este documento define las tres vías posibles para implementar la skill de Liderazgo Situacional en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Liderazgo Situacional",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Liderazgo Situacional"""
    print(f"Iniciando flujo técnico para: Liderazgo Situacional")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Liderazgo Situacional"}
...
**REST Endpoint:** `POST /v1/automate/321`
