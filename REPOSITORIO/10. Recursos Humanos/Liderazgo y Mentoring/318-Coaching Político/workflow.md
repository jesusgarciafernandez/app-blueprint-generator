---
title: Master Workflow: Coaching Político
version: 1.1
...
subcategory: General
tags: ['political-intelligence', 'power-dynamics', 'leadership', 'organizational-savvy', 'influence', 'negotiation', 'stakeholder-management', 'diplomacy']
...
# 🚀 Estrategia de Automatización: Coaching Político

Este documento define las tres vías posibles para implementar la skill de Coaching Político en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Coaching Político",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Coaching Político"""
    print(f"Iniciando flujo técnico para: Coaching Político")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Coaching Político"}
...
**REST Endpoint:** `POST /v1/automate/318`
