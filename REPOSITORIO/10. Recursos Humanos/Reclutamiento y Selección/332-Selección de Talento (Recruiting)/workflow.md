---
title: Master Workflow: Selección de Talento (Recruiting)
version: 1.1
...
subcategory: General
tags: ['recruiting', 'inbound-recruiting', 'employer-branding', 'talent-acquisition', 'technical-interviewing', 'cultural-fit', 'ats', 'headhunting']
...
# 🚀 Estrategia de Automatización: Selección de Talento (Recruiting)

Este documento define las tres vías posibles para implementar la skill de Selección de Talento (Recruiting) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Selección de Talento (Recruiting)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Selección de Talento (Recruiting)"""
    print(f"Iniciando flujo técnico para: Selección de Talento (Recruiting)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Selección de Talento (Recruiting)"}
...
**REST Endpoint:** `POST /v1/automate/332`
