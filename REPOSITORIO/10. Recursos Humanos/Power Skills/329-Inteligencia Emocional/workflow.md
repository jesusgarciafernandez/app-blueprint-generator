---
title: Master Workflow: Inteligencia Emocional
version: 1.1
...
subcategory: General
tags: ['emotional-intelligence', 'eq', 'self-awareness', 'empathy', 'social-skills', 'motivation', 'leadership', 'self-regulation']
...
# 🚀 Estrategia de Automatización: Inteligencia Emocional

Este documento define las tres vías posibles para implementar la skill de Inteligencia Emocional en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Inteligencia Emocional",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Inteligencia Emocional"""
    print(f"Iniciando flujo técnico para: Inteligencia Emocional")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Inteligencia Emocional"}
...
**REST Endpoint:** `POST /v1/automate/329`
