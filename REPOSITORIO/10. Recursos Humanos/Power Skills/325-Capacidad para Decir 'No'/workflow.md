---
title: Master Workflow: Capacidad para Decir 'No'
version: 1.1
...
subcategory: General
tags: ['assertiveness', 'boundaries', 'time-management', 'power-skills', 'emotional-intelligence', 'productivity-bias', 'essentialism']
...
# 🚀 Estrategia de Automatización: Capacidad para Decir 'No'

Este documento define las tres vías posibles para implementar la skill de Capacidad para Decir 'No' en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Capacidad para Decir 'No'",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Capacidad para Decir 'No'"""
    print(f"Iniciando flujo técnico para: Capacidad para Decir 'No'")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Capacidad para Decir 'No'"}
...
**REST Endpoint:** `POST /v1/automate/325`
