---
title: Master Workflow: Escucha Activa
version: 1.1
...
subcategory: General
tags: ['active-listening', 'communication', 'feedback', 'empathy', 'interpersonal-skills', 'soft-skills', 'negotiation', 'influence']
...
# 🚀 Estrategia de Automatización: Escucha Activa

Este documento define las tres vías posibles para implementar la skill de Escucha Activa en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Escucha Activa"""
    print(f"Iniciando flujo técnico para: Escucha Activa")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Escucha Activa"}
...
**REST Endpoint:** `POST /v1/automate/328`
