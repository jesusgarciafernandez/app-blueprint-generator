---
title: Master Workflow: Empatía Cognitiva
version: 1.1
...
subcategory: General
tags: ['cognitive-empathy', 'perspective-taking', 'emotional-intelligence', 'ux-research', 'leadership', 'negotiation', 'psychology', 'social-intelligence']
...
# 🚀 Estrategia de Automatización: Empatía Cognitiva

Este documento define las tres vías posibles para implementar la skill de Empatía Cognitiva en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Empatía Cognitiva",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Empatía Cognitiva"""
    print(f"Iniciando flujo técnico para: Empatía Cognitiva")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Empatía Cognitiva"}
...
**REST Endpoint:** `POST /v1/automate/326`
