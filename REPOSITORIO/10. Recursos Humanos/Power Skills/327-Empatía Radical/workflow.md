---
title: Master Workflow: Empatía Radical
version: 1.1
...
subcategory: General
tags: ['radical-empathy', 'emotional-intelligence', 'inclusive-design', 'conflict-resolution', 'active-listening', 'psychological-safety', 'diversity-inclusion', 'human-centered-approaches']
...
# 🚀 Estrategia de Automatización: Empatía Radical

Este documento define las tres vías posibles para implementar la skill de Empatía Radical en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Empatía Radical"""
    print(f"Iniciando flujo técnico para: Empatía Radical")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Empatía Radical"}
...
**REST Endpoint:** `POST /v1/automate/327`
