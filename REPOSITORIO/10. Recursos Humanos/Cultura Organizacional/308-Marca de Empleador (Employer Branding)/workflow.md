---
title: Master Workflow: Marca de Empleador (Employer Branding)
version: 1.1
...
subcategory: General
tags: ['employer-branding', 'talent-acquisition', 'corporate-culture', 'employee-experience', 'recruitment-marketing', 'evp-design', 'digital-recruitment', 'internal-branding']
...
# 🚀 Estrategia de Automatización: Marca de Empleador (Employer Branding)

Este documento define las tres vías posibles para implementar la skill de Marca de Empleador (Employer Branding) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Marca de Empleador (Employer Branding)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Marca de Empleador (Employer Branding)"""
    print(f"Iniciando flujo técnico para: Marca de Empleador (Employer Branding)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Marca de Empleador (Employer Branding)"}
...
**REST Endpoint:** `POST /v1/automate/308`
