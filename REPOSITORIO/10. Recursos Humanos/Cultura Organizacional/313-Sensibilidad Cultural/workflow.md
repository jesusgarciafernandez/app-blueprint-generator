---
title: Master Workflow: Sensibilidad Cultural
version: 1.1
...
subcategory: General
tags: ['cultural-sensitivity', 'diversity', 'global-leadership', 'inclusion', 'cross-cultural-communication', 'empathy', 'international-business', 'adaptability']
...
# 🚀 Estrategia de Automatización: Sensibilidad Cultural

Este documento define las tres vías posibles para implementar la skill de Sensibilidad Cultural en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Sensibilidad Cultural",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Sensibilidad Cultural"""
    print(f"Iniciando flujo técnico para: Sensibilidad Cultural")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Sensibilidad Cultural"}
...
**REST Endpoint:** `POST /v1/automate/313`
