---
title: Master Workflow: Gestión del Cambio
version: 1.1
...
subcategory: General
tags: ['change-management', 'transformation', 'leadership', 'organizational-culture', 'adkar', 'kotter', 'resilience', 'innovation']
...
# 🚀 Estrategia de Automatización: Gestión del Cambio

Este documento define las tres vías posibles para implementar la skill de Gestión del Cambio en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión del Cambio",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión del Cambio"""
    print(f"Iniciando flujo técnico para: Gestión del Cambio")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión del Cambio"}
...
**REST Endpoint:** `POST /v1/automate/304`
