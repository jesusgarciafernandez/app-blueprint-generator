---
title: Master Workflow: Protección de Minorías
version: 1.1
...
subcategory: General
tags: ['minority-rights', 'anti-discrimination', 'inclusive-culture', 'psychological-safety', 'harassment-prevention', 'equitable-workplace', 'vulnerable-groups-protection', 'dei-ops']
...
# 🚀 Estrategia de Automatización: Protección de Minorías

Este documento define las tres vías posibles para implementar la skill de Protección de Minorías en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Protección de Minorías",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Protección de Minorías"""
    print(f"Iniciando flujo técnico para: Protección de Minorías")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Protección de Minorías"}
...
**REST Endpoint:** `POST /v1/automate/311`
