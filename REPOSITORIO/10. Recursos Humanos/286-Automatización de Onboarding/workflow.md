---
title: Master Workflow: Automatización de Onboarding
version: 1.1
...
subcategory: General
tags: [onboarding, hr, automation, form]
...
# 🚀 Estrategia de Automatización: Automatización de Onboarding

Este documento define las tres vías posibles para implementar la skill de Automatización de Onboarding en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Automatización de Onboarding",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Automatización de Onboarding"""
    print(f"Iniciando flujo técnico para: Automatización de Onboarding")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Automatización de Onboarding"}
...
**REST Endpoint:** `POST /v1/automate/286`
