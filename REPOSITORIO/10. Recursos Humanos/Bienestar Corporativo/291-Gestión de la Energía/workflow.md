---
title: Master Workflow: Gestión de la Energía
version: 1.1
...
subcategory: General
tags: ['energy-management', 'circadian-rhythms', 'ultradian-rhythms', 'high-performance', 'well-being', 'biohacking', 'productivity']
...
# 🚀 Estrategia de Automatización: Gestión de la Energía

Este documento define las tres vías posibles para implementar la skill de Gestión de la Energía en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de la Energía",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de la Energía"""
    print(f"Iniciando flujo técnico para: Gestión de la Energía")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de la Energía"}
...
**REST Endpoint:** `POST /v1/automate/291`
