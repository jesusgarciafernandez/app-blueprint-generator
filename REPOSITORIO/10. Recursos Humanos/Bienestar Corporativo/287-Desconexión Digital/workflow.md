---
title: Master Workflow: Desconexión Digital
version: 1.1
...
subcategory: General
tags: ['digital-detox', 'minimalism', 'mental-health', 'cal-newport', 'focus', 'tech-balance', 'burnout-prevention']
...
# 🚀 Estrategia de Automatización: Desconexión Digital

Este documento define las tres vías posibles para implementar la skill de Desconexión Digital en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Desconexión Digital",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Desconexión Digital"""
    print(f"Iniciando flujo técnico para: Desconexión Digital")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Desconexión Digital"}
...
**REST Endpoint:** `POST /v1/automate/287`
