---
title: Master Workflow: Discovery
version: 1.1
...
category: 00. Sistema
subcategory: General
tags: ["search", "index", "retrieval", "context", "discovery"]
...
# 🚀 Estrategia de Automatización: Discovery

Este documento define las tres vías posibles para implementar la skill de Discovery en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Discovery"""
    print(f"Iniciando flujo técnico para: Discovery")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Discovery"}
...
**REST Endpoint:** `POST /v1/automate/001`
