---
title: Master Workflow: Social Selling
version: 1.1
...
# 🚀 Estrategia de Automatización: Social Selling

Este documento define las tres vías posibles para implementar la skill de Social Selling en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Social Selling"""
    print(f"Iniciando flujo técnico para: Social Selling")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Social Selling"}
...
**REST Endpoint:** `POST /v1/automate/162`
