---
title: Master Workflow: Negociación Win-Win
version: 1.1
...
subcategory: General
tags: ['negotiation', 'win-win', 'harvard-method', 'batna', 'strategy', 'conflict-resolution', 'sales', 'contracts', 'partnerships']
...
# 🚀 Estrategia de Automatización: Negociación Win-Win

Este documento define las tres vías posibles para implementar la skill de Negociación Win-Win en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Negociación Win-Win",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Negociación Win-Win"""
    print(f"Iniciando flujo técnico para: Negociación Win-Win")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Negociación Win-Win"}
...
**REST Endpoint:** `POST /v1/automate/152`
