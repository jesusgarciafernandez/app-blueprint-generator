---
title: Master Workflow: Venta Consultiva
version: 1.1
...
subcategory: General
tags: ['consultative-selling', 'b2b-sales', 'value-proposition', 'relationship-management', 'spin-selling']
...
# 🚀 Estrategia de Automatización: Venta Consultiva

Este documento define las tres vías posibles para implementar la skill de Venta Consultiva en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Venta Consultiva"""
    print(f"Iniciando flujo técnico para: Venta Consultiva")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Venta Consultiva"}
...
**REST Endpoint:** `POST /v1/automate/155`
