---
title: Master Workflow: Técnicas de Cierre de Ventas
version: 1.1
...
subcategory: General
tags: ['sales-closing', 'negotiation-skills', 'influence', 'deal-making', 'sales-psychology']
...
# 🚀 Estrategia de Automatización: Técnicas de Cierre de Ventas

Este documento define las tres vías posibles para implementar la skill de Técnicas de Cierre de Ventas en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Técnicas de Cierre de Ventas",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Técnicas de Cierre de Ventas"""
    print(f"Iniciando flujo técnico para: Técnicas de Cierre de Ventas")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Técnicas de Cierre de Ventas"}
...
**REST Endpoint:** `POST /v1/automate/154`
