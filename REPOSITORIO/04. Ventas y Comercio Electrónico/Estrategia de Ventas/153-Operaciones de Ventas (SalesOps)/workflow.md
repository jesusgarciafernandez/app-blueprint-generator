---
title: Master Workflow: Operaciones de Ventas (SalesOps)
version: 1.1
...
subcategory: General
tags: ['salesops', 'crm-optimization', 'sales-enablement', 'revenue-ops', 'lead-scoring', 'sales-automation', 'pipeline-management']
...
# 🚀 Estrategia de Automatización: Operaciones de Ventas (SalesOps)

Este documento define las tres vías posibles para implementar la skill de Operaciones de Ventas (SalesOps) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Operaciones de Ventas (SalesOps)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Operaciones de Ventas (SalesOps)"""
    print(f"Iniciando flujo técnico para: Operaciones de Ventas (SalesOps)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Operaciones de Ventas (SalesOps)"}
...
**REST Endpoint:** `POST /v1/automate/153`
