---
title: Master Workflow: Manejo de Objeciones
version: 1.1
...
# 🚀 Estrategia de Automatización: Manejo de Objeciones

Este documento define las tres vías posibles para implementar la skill de Manejo de Objeciones en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Manejo de Objeciones",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Manejo de Objeciones"""
    print(f"Iniciando flujo técnico para: Manejo de Objeciones")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Manejo de Objeciones"}
...
**REST Endpoint:** `POST /v1/automate/150`
