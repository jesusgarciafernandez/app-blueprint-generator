---
title: Master Workflow: Visual Merchandising Digital
version: 1.1
...
subcategory: General
tags: ['visual-merchandising', 'e-commerce-design', 'conversion-optimization', 'product-display', 'digital-retail']
...
# 🚀 Estrategia de Automatización: Visual Merchandising Digital

Este documento define las tres vías posibles para implementar la skill de Visual Merchandising Digital en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Visual Merchandising Digital",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Visual Merchandising Digital"""
    print(f"Iniciando flujo técnico para: Visual Merchandising Digital")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Visual Merchandising Digital"}
...
**REST Endpoint:** `POST /v1/automate/157`
