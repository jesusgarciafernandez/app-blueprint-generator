---
title: Master Workflow: Estrategia de Retención (Churn)
version: 1.1
...
subcategory: General
tags: ['customer-retention', 'churn-reduction', 'ltv-optimization', 'customer-success', 'win-back-strategy']
...
# 🚀 Estrategia de Automatización: Estrategia de Retención (Churn)

Este documento define las tres vías posibles para implementar la skill de Estrategia de Retención (Churn) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Estrategia de Retención (Churn)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Estrategia de Retención (Churn)"""
    print(f"Iniciando flujo técnico para: Estrategia de Retención (Churn)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Estrategia de Retención (Churn)"}
...
**REST Endpoint:** `POST /v1/automate/160`
