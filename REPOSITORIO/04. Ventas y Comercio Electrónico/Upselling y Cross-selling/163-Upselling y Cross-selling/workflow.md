---
title: Master Workflow: Upselling y Cross-selling
version: 1.1
...
# 🚀 Estrategia de Automatización: Upselling y Cross-selling

Este documento define las tres vías posibles para implementar la skill de Upselling y Cross-selling en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Upselling y Cross-selling",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Upselling y Cross-selling"""
    print(f"Iniciando flujo técnico para: Upselling y Cross-selling")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Upselling y Cross-selling"}
...
**REST Endpoint:** `POST /v1/automate/163`
