---
title: Master Workflow: Marca Personal (Personal Branding)
version: 1.1
...
subcategory: General
tags: ['personal-branding', 'authority-building', 'professional-identity', 'social-selling', 'content-marketing', 'digital-reputation', 'executive-presence', 'career-strategy']
...
# 🚀 Estrategia de Automatización: Marca Personal (Personal Branding)

Este documento define las tres vías posibles para implementar la skill de Marca Personal (Personal Branding) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Marca Personal (Personal Branding)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Marca Personal (Personal Branding)"""
    print(f"Iniciando flujo técnico para: Marca Personal (Personal Branding)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Marca Personal (Personal Branding)"}
...
**REST Endpoint:** `POST /v1/automate/568`
