---
title: Master Workflow: Storytelling Personal
version: 1.1
...
subcategory: General
tags: ['storytelling', 'personal-branding', 'narrative', 'influence', 'career-development', 'communication', 'metaphor', 'leadership-presence']
...
# 🚀 Estrategia de Automatización: Storytelling Personal

Este documento define las tres vías posibles para implementar la skill de Storytelling Personal en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Storytelling Personal",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Storytelling Personal"""
    print(f"Iniciando flujo técnico para: Storytelling Personal")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Storytelling Personal"}
...
**REST Endpoint:** `POST /v1/automate/571`
