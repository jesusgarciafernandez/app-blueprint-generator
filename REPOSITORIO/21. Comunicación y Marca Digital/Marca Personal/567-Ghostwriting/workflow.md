---
title: Master Workflow: Ghostwriting
version: 1.1
...
subcategory: General
tags: ['ghostwriting', 'executive-communication', 'thought-leadership', 'brand-voice-cloning', 'strategic-writing', 'narrative-style', 'confidentiality', 'authority-building']
...
# 🚀 Estrategia de Automatización: Ghostwriting

Este documento define las tres vías posibles para implementar la skill de Ghostwriting en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Ghostwriting"""
    print(f"Iniciando flujo técnico para: Ghostwriting")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Ghostwriting"}
...
**REST Endpoint:** `POST /v1/automate/567`
