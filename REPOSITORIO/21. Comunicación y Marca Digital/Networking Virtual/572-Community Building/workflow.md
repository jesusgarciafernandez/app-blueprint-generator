---
title: Master Workflow: Community Building
version: 1.1
...
subcategory: General
tags: ['community-building', 'engagement-strategy', 'digital-tribes', 'community-management', 'member-loyalty', 'governance', 'social-capital', 'advocacy']
...
# 🚀 Estrategia de Automatización: Community Building

Este documento define las tres vías posibles para implementar la skill de Community Building en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Community Building",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Community Building"""
    print(f"Iniciando flujo técnico para: Community Building")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Community Building"}
...
**REST Endpoint:** `POST /v1/automate/572`
