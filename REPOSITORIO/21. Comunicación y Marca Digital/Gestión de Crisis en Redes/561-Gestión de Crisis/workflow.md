---
title: Master Workflow: Gestión de Crisis
version: 1.1
...
subcategory: General
tags: ['crisis-management', 'reputation', 'war-room', 'resilience', 'public-relations', 'crisis-comms', 'incident-response', 'social-media-crisis']
...
# 🚀 Estrategia de Automatización: Gestión de Crisis

Este documento define las tres vías posibles para implementar la skill de Gestión de Crisis en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de Crisis",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de Crisis"""
    print(f"Iniciando flujo técnico para: Gestión de Crisis")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de Crisis"}
...
**REST Endpoint:** `POST /v1/automate/561`
