---
title: Master Workflow: Gestión de Crisis en Redes
version: 1.1
...
subcategory: General
tags: ['crisis-management', 'reputation-management', 'online-crisis', 'pr-strategy', 'incident-response', 'social-media-safety', 'community-management', 'brand-protection']
...
# 🚀 Estrategia de Automatización: Gestión de Crisis en Redes

Este documento define las tres vías posibles para implementar la skill de Gestión de Crisis en Redes en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de Crisis en Redes",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de Crisis en Redes"""
    print(f"Iniciando flujo técnico para: Gestión de Crisis en Redes")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de Crisis en Redes"}
...
**REST Endpoint:** `POST /v1/automate/562`
