---
title: Master Workflow: Ética de la Comunicación
version: 1.1
...
subcategory: General
tags: ['ethics-in-comms', 'transparency', 'brand-integrity', 'dei', 'responsible-marketing', 'digital-accountability', 'truth-in-advertising', 'corporate-values']
...
# 🚀 Estrategia de Automatización: Ética de la Comunicación

Este documento define las tres vías posibles para implementar la skill de Ética de la Comunicación en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Ética de la Comunicación",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Ética de la Comunicación"""
    print(f"Iniciando flujo técnico para: Ética de la Comunicación")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Ética de la Comunicación"}
...
**REST Endpoint:** `POST /v1/automate/579`
