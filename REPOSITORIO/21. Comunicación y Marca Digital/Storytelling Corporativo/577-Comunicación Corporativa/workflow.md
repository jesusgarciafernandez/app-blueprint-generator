---
title: Master Workflow: Comunicación Corporativa
version: 1.1
...
subcategory: General
tags: ['corporate-communication', 'internal-comms', 'stakeholder-engagement', 'brand-voice', 'crisis-comms', 'transparency', 'information-flow', 'intranet']
...
# 🚀 Estrategia de Automatización: Comunicación Corporativa

Este documento define las tres vías posibles para implementar la skill de Comunicación Corporativa en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Comunicación Corporativa",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Comunicación Corporativa"""
    print(f"Iniciando flujo técnico para: Comunicación Corporativa")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Comunicación Corporativa"}
...
**REST Endpoint:** `POST /v1/automate/577`
