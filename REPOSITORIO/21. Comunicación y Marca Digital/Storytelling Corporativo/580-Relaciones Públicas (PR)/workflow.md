---
title: Master Workflow: Relaciones Públicas (PR)
version: 1.1
...
subcategory: General
tags: ['pr', 'media-relations', 'crisis-management', 'brand-authority', 'press-release', 'influencer-outreach', 'corporate-communications', 'digital-footprint']
...
# 🚀 Estrategia de Automatización: Relaciones Públicas (PR)

Este documento define las tres vías posibles para implementar la skill de Relaciones Públicas (PR) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Relaciones Públicas (PR)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Relaciones Públicas (PR)"""
    print(f"Iniciando flujo técnico para: Relaciones Públicas (PR)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Relaciones Públicas (PR)"}
...
**REST Endpoint:** `POST /v1/automate/580`
