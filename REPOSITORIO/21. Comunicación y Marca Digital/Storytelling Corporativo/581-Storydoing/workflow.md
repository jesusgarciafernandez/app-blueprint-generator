---
title: Master Workflow: Storydoing
version: 1.1
...
# 🚀 Estrategia de Automatización: Storydoing

Este documento define las tres vías posibles para implementar la skill de Storydoing en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Storydoing"""
    print(f"Iniciando flujo técnico para: Storydoing")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Storydoing"}
...
**REST Endpoint:** `POST /v1/automate/581`
