---
title: Master Workflow: Comunicación de Impacto
version: 1.1
...
subcategory: General
tags: ['impact-comms', 'persuasion-techniques', 'public-speaking', 'executive-presence', 'narrative-influence', 'memorable-messaging', 'strategic-comms', 'rhetoric-skills']
...
# 🚀 Estrategia de Automatización: Comunicación de Impacto

Este documento define las tres vías posibles para implementar la skill de Comunicación de Impacto en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Comunicación de Impacto",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Comunicación de Impacto"""
    print(f"Iniciando flujo técnico para: Comunicación de Impacto")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Comunicación de Impacto"}
...
**REST Endpoint:** `POST /v1/automate/578`
