---
title: Master Workflow: User-Generated Content (UGC)
version: 1.1
...
subcategory: General
tags: ['ugc', 'social-proof', 'community-content', 'content-marketing', 'brand-advocacy']
...
# 🚀 Estrategia de Automatización: User-Generated Content (UGC)

Este documento define las tres vías posibles para implementar la skill de User-Generated Content (UGC) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "User-Generated Content (UGC)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de User-Generated Content (UGC)"""
    print(f"Iniciando flujo técnico para: User-Generated Content (UGC)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "User-Generated Content (UGC)"}
...
**REST Endpoint:** `POST /v1/automate/110`
