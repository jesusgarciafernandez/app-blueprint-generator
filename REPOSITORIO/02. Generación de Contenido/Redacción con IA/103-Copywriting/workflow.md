---
title: Master Workflow: Copywriting
version: 1.1
...
subcategory: General
tags: ['copywriting', 'persuasion', 'sales-copy', 'content-strategy', 'ai-writing']
...
# 🚀 Estrategia de Automatización: Copywriting

Este documento define las tres vías posibles para implementar la skill de Copywriting en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Copywriting"""
    print(f"Iniciando flujo técnico para: Copywriting")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Copywriting"}
...
**REST Endpoint:** `POST /v1/automate/103`
