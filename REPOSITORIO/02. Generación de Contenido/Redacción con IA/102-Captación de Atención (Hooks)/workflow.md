---
title: Master Workflow: Captación de Atención (Hooks)
version: 1.1
...
subcategory: General
tags: ['attention-hooks', 'copywriting', 'retention-strategy', 'psychology-of-attention', 'digital-marketing', 'content-hooks', 'ctr-optimization', 'engagement-hacks']
...
# 🚀 Estrategia de Automatización: Captación de Atención (Hooks)

Este documento define las tres vías posibles para implementar la skill de Captación de Atención (Hooks) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Captación de Atención (Hooks)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Captación de Atención (Hooks)"""
    print(f"Iniciando flujo técnico para: Captación de Atención (Hooks)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Captación de Atención (Hooks)"}
...
**REST Endpoint:** `POST /v1/automate/102`
