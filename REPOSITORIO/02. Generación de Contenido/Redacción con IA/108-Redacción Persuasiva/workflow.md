---
title: Master Workflow: Redacción Persuasiva
version: 1.1
...
subcategory: General
tags: ['copywriting', 'persuasion', 'marketing', 'nlp', 'sales-writing', 'content-strategy', 'ai-writing', 'psychology']
...
# 🚀 Estrategia de Automatización: Redacción Persuasiva

Este documento define las tres vías posibles para implementar la skill de Redacción Persuasiva en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Redacción Persuasiva",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Redacción Persuasiva"""
    print(f"Iniciando flujo técnico para: Redacción Persuasiva")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Redacción Persuasiva"}
...
**REST Endpoint:** `POST /v1/automate/108`
