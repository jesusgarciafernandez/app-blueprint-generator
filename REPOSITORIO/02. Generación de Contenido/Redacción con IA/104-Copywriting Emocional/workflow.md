---
title: Master Workflow: Copywriting Emocional
version: 1.1
...
subcategory: General
tags: ['emotional-copywriting', 'neurocopywriting', 'persuasion-techniques', 'storytelling', 'consumer-psychology', 'sales-copy', 'brand-voice', 'empathy-mapping']
...
# 🚀 Estrategia de Automatización: Copywriting Emocional

Este documento define las tres vías posibles para implementar la skill de Copywriting Emocional en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Copywriting Emocional",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Copywriting Emocional"""
    print(f"Iniciando flujo técnico para: Copywriting Emocional")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Copywriting Emocional"}
...
**REST Endpoint:** `POST /v1/automate/104`
