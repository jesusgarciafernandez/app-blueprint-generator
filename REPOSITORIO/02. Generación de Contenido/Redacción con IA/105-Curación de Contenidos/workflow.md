---
title: Master Workflow: Curación de Contenidos
version: 1.1
...
subcategory: General
tags: ['content-curation', 'knowledge-management', 'information-filtering', 'thought-leadership', 'content-strategy', 'digital-intelligence', 'aggregation', 'trend-watching']
...
# 🚀 Estrategia de Automatización: Curación de Contenidos

Este documento define las tres vías posibles para implementar la skill de Curación de Contenidos en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Curación de Contenidos",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Curación de Contenidos"""
    print(f"Iniciando flujo técnico para: Curación de Contenidos")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Curación de Contenidos"}
...
**REST Endpoint:** `POST /v1/automate/105`
