---
title: Master Workflow: Diseño de Presentaciones
version: 1.1
...
subcategory: General
tags: ['presentation-design', 'pitch-deck', 'visual-storytelling', 'powerpoint', 'keynote', 'information-design']
...
# 🚀 Estrategia de Automatización: Diseño de Presentaciones

Este documento define las tres vías posibles para implementar la skill de Diseño de Presentaciones en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Diseño de Presentaciones",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Diseño de Presentaciones"""
    print(f"Iniciando flujo técnico para: Diseño de Presentaciones")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Diseño de Presentaciones"}
...
**REST Endpoint:** `POST /v1/automate/088`
