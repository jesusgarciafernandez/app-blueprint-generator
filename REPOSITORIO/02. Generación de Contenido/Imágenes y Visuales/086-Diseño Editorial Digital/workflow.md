---
title: Master Workflow: Diseño Editorial Digital
version: 1.1
...
subcategory: General
tags: ['editorial-design', 'indesign', 'ebooks', 'whitepapers', 'digital-publishing']
...
# 🚀 Estrategia de Automatización: Diseño Editorial Digital

Este documento define las tres vías posibles para implementar la skill de Diseño Editorial Digital en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Diseño Editorial Digital",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Diseño Editorial Digital"""
    print(f"Iniciando flujo técnico para: Diseño Editorial Digital")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Diseño Editorial Digital"}
...
**REST Endpoint:** `POST /v1/automate/086`
