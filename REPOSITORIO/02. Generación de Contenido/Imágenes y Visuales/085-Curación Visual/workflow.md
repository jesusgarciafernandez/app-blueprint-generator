---
title: Master Workflow: Curación Visual
version: 1.1
...
subcategory: General
tags: ['visual-curation', 'art-direction', 'moodboard', 'visual-identity', 'brand-consistency', 'visual-storytelling']
...
# 🚀 Estrategia de Automatización: Curación Visual

Este documento define las tres vías posibles para implementar la skill de Curación Visual en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Curación Visual"""
    print(f"Iniciando flujo técnico para: Curación Visual")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Curación Visual"}
...
**REST Endpoint:** `POST /v1/automate/085`
