---
title: Master Workflow: IA Generativa de Imágenes
version: 1.1
...
subcategory: General
tags: ['gen-ai', 'stable-diffusion', 'midjourney', 'dall-e-3', 'flux', 'image-generation', 'prompt-engineering', 'creative-ai']
...
# 🚀 Estrategia de Automatización: IA Generativa de Imágenes

Este documento define las tres vías posibles para implementar la skill de IA Generativa de Imágenes en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "IA Generativa de Imágenes",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de IA Generativa de Imágenes"""
    print(f"Iniciando flujo técnico para: IA Generativa de Imágenes")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "IA Generativa de Imágenes"}
...
**REST Endpoint:** `POST /v1/automate/090`
