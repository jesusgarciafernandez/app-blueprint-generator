---
title: Master Workflow: Retoque Fotográfico (Photoshop)
version: 1.1
...
subcategory: General
tags: ['photo-retouching', 'photoshop', 'high-end-retouch', 'digital-composition', 'color-grading']
...
# 🚀 Estrategia de Automatización: Retoque Fotográfico (Photoshop)

Este documento define las tres vías posibles para implementar la skill de Retoque Fotográfico (Photoshop) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Retoque Fotográfico (Photoshop)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Retoque Fotográfico (Photoshop)"""
    print(f"Iniciando flujo técnico para: Retoque Fotográfico (Photoshop)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Retoque Fotográfico (Photoshop)"}
...
**REST Endpoint:** `POST /v1/automate/095`
