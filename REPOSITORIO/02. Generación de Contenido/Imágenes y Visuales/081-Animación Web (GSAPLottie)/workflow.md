---
title: Master Workflow: Animación Web (GSAPLottie)
version: 1.1
...
subcategory: General
tags: ['web-animation', 'gsap', 'lottie', 'svg-animation', 'scroll-trigger', 'ux-motion', 'frontend', 'performance', 'canvas']
...
# 🚀 Estrategia de Automatización: Animación Web (GSAPLottie)

Este documento define las tres vías posibles para implementar la skill de Animación Web (GSAPLottie) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Animación Web (GSAPLottie)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Animación Web (GSAPLottie)"""
    print(f"Iniciando flujo técnico para: Animación Web (GSAPLottie)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Animación Web (GSAPLottie)"}
...
**REST Endpoint:** `POST /v1/automate/081`
