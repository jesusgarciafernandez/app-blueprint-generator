---
title: Master Workflow: Comunicación Visual para No Diseñadores
version: 1.1
...
subcategory: General
tags: ['visual-communication', 'graphic-design-basics', 'canva-mastery', 'visual-brand-identity', 'content-creation', 'ui-ux-essentials', 'color-theory', 'agile-design']
...
# 🚀 Estrategia de Automatización: Comunicación Visual para No Diseñadores

Este documento define las tres vías posibles para implementar la skill de Comunicación Visual para No Diseñadores en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Comunicación Visual para No Diseñadores",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Comunicación Visual para No Diseñadores"""
    print(f"Iniciando flujo técnico para: Comunicación Visual para No Diseñadores")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Comunicación Visual para No Diseñadores"}
...
**REST Endpoint:** `POST /v1/automate/084`
