---
title: Master Workflow: Storyboarding
version: 1.1
...
subcategory: General
tags: ['storyboarding', 'visual-narrative', 'pre-production', 'ux-storyboards', 'storytelling']
...
# 🚀 Estrategia de Automatización: Storyboarding

Este documento define las tres vías posibles para implementar la skill de Storyboarding en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Storyboarding"""
    print(f"Iniciando flujo técnico para: Storyboarding")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Storyboarding"}
...
**REST Endpoint:** `POST /v1/automate/118`
