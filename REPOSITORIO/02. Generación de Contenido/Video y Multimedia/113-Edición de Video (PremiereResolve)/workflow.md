---
title: Master Workflow: Edición de Video (PremiereResolve)
version: 1.1
...
subcategory: General
tags: ['video-editing', 'premiere-pro', 'davinci-resolve', 'color-grading', 'storytelling']
...
# 🚀 Estrategia de Automatización: Edición de Video (PremiereResolve)

Este documento define las tres vías posibles para implementar la skill de Edición de Video (PremiereResolve) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Edición de Video (PremiereResolve)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Edición de Video (PremiereResolve)"""
    print(f"Iniciando flujo técnico para: Edición de Video (PremiereResolve)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Edición de Video (PremiereResolve)"}
...
**REST Endpoint:** `POST /v1/automate/113`
