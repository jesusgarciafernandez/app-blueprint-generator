---
title: Master Workflow: Realidad Aumentada (AR)
version: 1.1
...
subcategory: General
tags: ['ar', 'augmented-reality', 'spark-ar', '8th-wall', 'unity', 'webxr', 'immersive-tech', '3d-modeling']
...
# 🚀 Estrategia de Automatización: Realidad Aumentada (AR)

Este documento define las tres vías posibles para implementar la skill de Realidad Aumentada (AR) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Realidad Aumentada (AR)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Realidad Aumentada (AR)"""
    print(f"Iniciando flujo técnico para: Realidad Aumentada (AR)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Realidad Aumentada (AR)"}
...
**REST Endpoint:** `POST /v1/automate/116`
