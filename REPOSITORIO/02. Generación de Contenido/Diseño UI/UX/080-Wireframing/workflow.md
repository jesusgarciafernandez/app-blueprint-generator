---
title: Master Workflow: Wireframing
version: 1.1
...
subcategory: General
tags: ['wireframing', 'low-fidelity', 'information-architecture', 'ux-design', 'interface-structure']
...
# 🚀 Estrategia de Automatización: Wireframing

Este documento define las tres vías posibles para implementar la skill de Wireframing en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Wireframing"""
    print(f"Iniciando flujo técnico para: Wireframing")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Wireframing"}
...
**REST Endpoint:** `POST /v1/automate/080`
