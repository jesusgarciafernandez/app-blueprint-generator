---
title: Master Workflow: Usability Testing
version: 1.1
...
# 🚀 Estrategia de Automatización: Usability Testing

Este documento define las tres vías posibles para implementar la skill de Usability Testing en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Usability Testing",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Usability Testing"""
    print(f"Iniciando flujo técnico para: Usability Testing")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Usability Testing"}
...
**REST Endpoint:** `POST /v1/automate/077`
