---
title: Master Workflow: Experiencia de Usuario (UX)
version: 1.1
...
subcategory: General
tags: ['ux-design', 'user-experience', 'usability', 'user-research', 'interaction-design']
...
# 🚀 Estrategia de Automatización: Experiencia de Usuario (UX)

Este documento define las tres vías posibles para implementar la skill de Experiencia de Usuario (UX) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Experiencia de Usuario (UX)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Experiencia de Usuario (UX)"""
    print(f"Iniciando flujo técnico para: Experiencia de Usuario (UX)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Experiencia de Usuario (UX)"}
...
**REST Endpoint:** `POST /v1/automate/071`
