---
title: Master Workflow: UX Writing
version: 1.1
...
subcategory: General
tags: ['ux-writing', 'microcopy', 'content-design', 'voice-and-tone', 'user-experience']
...
# 🚀 Estrategia de Automatización: UX Writing

Este documento define las tres vías posibles para implementar la skill de UX Writing en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de UX Writing"""
    print(f"Iniciando flujo técnico para: UX Writing")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "UX Writing"}
...
**REST Endpoint:** `POST /v1/automate/076`
