---
title: Master Workflow: Diseño Centrado en el Humano
version: 1.1
...
# 🚀 Estrategia de Automatización: Diseño Centrado en el Humano

Este documento define las tres vías posibles para implementar la skill de Diseño Centrado en el Humano en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Diseño Centrado en el Humano",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Diseño Centrado en el Humano"""
    print(f"Iniciando flujo técnico para: Diseño Centrado en el Humano")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Diseño Centrado en el Humano"}
...
**REST Endpoint:** `POST /v1/automate/060`
