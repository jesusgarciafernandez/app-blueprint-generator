---
title: Master Workflow: Diseño Visual (UI)
version: 1.1
...
subcategory: General
tags: ['ui-design', 'interface', 'visual-hierarchy', 'design-systems', 'accessibility']
...
# 🚀 Estrategia de Automatización: Diseño Visual (UI)

Este documento define las tres vías posibles para implementar la skill de Diseño Visual (UI) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Diseño Visual (UI)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Diseño Visual (UI)"""
    print(f"Iniciando flujo técnico para: Diseño Visual (UI)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Diseño Visual (UI)"}
...
**REST Endpoint:** `POST /v1/automate/066`
