---
title: Master Workflow: User Research
version: 1.1
...
# 🚀 Estrategia de Automatización: User Research

Este documento define las tres vías posibles para implementar la skill de User Research en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de User Research"""
    print(f"Iniciando flujo técnico para: User Research")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "User Research"}
...
**REST Endpoint:** `POST /v1/automate/079`
