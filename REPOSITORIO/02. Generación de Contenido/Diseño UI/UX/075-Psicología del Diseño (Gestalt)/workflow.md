---
title: Master Workflow: Psicología del Diseño (Gestalt)
version: 1.1
...
subcategory: General
tags: ['gestalt-theory', 'design-psychology', 'visual-perception', 'ux-design', 'cognitive-load']
...
# 🚀 Estrategia de Automatización: Psicología del Diseño (Gestalt)

Este documento define las tres vías posibles para implementar la skill de Psicología del Diseño (Gestalt) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Psicología del Diseño (Gestalt)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Psicología del Diseño (Gestalt)"""
    print(f"Iniciando flujo técnico para: Psicología del Diseño (Gestalt)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Psicología del Diseño (Gestalt)"}
...
**REST Endpoint:** `POST /v1/automate/075`
