---
title: Master Workflow: Análisis Heurístico
version: 1.1
...
subcategory: General
tags: ['heuristic-evaluation', 'usability', 'ux-audit', 'nielsen-heuristics', 'user-experience', 'interaction-design']
...
# 🚀 Estrategia de Automatización: Análisis Heurístico

Este documento define las tres vías posibles para implementar la skill de Análisis Heurístico en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Análisis Heurístico",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Análisis Heurístico"""
    print(f"Iniciando flujo técnico para: Análisis Heurístico")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Análisis Heurístico"}
...
**REST Endpoint:** `POST /v1/automate/054`
