---
title: Master Workflow: Diseño Ético
version: 1.1
...
subcategory: General
tags: ['ethical-design', 'anti-dark-patterns', 'user-privacy', 'accessibility', 'human-rights', 'humane-technology']
...
# 🚀 Estrategia de Automatización: Diseño Ético

Este documento define las tres vías posibles para implementar la skill de Diseño Ético en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Diseño Ético"""
    print(f"Iniciando flujo técnico para: Diseño Ético")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Diseño Ético"}
...
**REST Endpoint:** `POST /v1/automate/062`
