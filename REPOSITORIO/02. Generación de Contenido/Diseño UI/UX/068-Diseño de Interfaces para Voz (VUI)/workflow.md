---
title: Master Workflow: Diseño de Interfaces para Voz (VUI)
version: 1.1
...
# 🚀 Estrategia de Automatización: Diseño de Interfaces para Voz (VUI)

Este documento define las tres vías posibles para implementar la skill de Diseño de Interfaces para Voz (VUI) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Diseño de Interfaces para Voz (VUI)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Diseño de Interfaces para Voz (VUI)"""
    print(f"Iniciando flujo técnico para: Diseño de Interfaces para Voz (VUI)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Diseño de Interfaces para Voz (VUI)"}
...
**REST Endpoint:** `POST /v1/automate/068`
