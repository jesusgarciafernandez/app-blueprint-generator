---
title: Master Workflow: Diseño Emocional
version: 1.1
...
subcategory: General
tags: ['emotional-design', 'ux-psychology', 'don-norman', 'user-delight', 'visceral-design', 'reflective-design']
...
# 🚀 Estrategia de Automatización: Diseño Emocional

Este documento define las tres vías posibles para implementar la skill de Diseño Emocional en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Diseño Emocional",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Diseño Emocional"""
    print(f"Iniciando flujo técnico para: Diseño Emocional")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Diseño Emocional"}
...
**REST Endpoint:** `POST /v1/automate/061`
