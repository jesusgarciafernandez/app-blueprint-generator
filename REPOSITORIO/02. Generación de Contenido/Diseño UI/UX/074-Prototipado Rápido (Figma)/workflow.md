---
title: Master Workflow: Prototipado Rápido (Figma)
version: 1.1
...
subcategory: General
tags: ['figma', 'prototyping', 'interaction-design', 'smart-animate', 'ux-validation']
...
# 🚀 Estrategia de Automatización: Prototipado Rápido (Figma)

Este documento define las tres vías posibles para implementar la skill de Prototipado Rápido (Figma) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Prototipado Rápido (Figma)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Prototipado Rápido (Figma)"""
    print(f"Iniciando flujo técnico para: Prototipado Rápido (Figma)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Prototipado Rápido (Figma)"}
...
**REST Endpoint:** `POST /v1/automate/074`
