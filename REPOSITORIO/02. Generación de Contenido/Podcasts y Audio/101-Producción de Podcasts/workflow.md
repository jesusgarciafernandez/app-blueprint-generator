---
title: Master Workflow: Producción de Podcasts
version: 1.1
...
subcategory: General
tags: ['podcast-production', 'audio-storytelling', 'scriptwriting', 'sound-design', 'audio-editing', 'distribution-platforms', 'voice-acting', 'monetization']
...
# 🚀 Estrategia de Automatización: Producción de Podcasts

Este documento define las tres vías posibles para implementar la skill de Producción de Podcasts en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Producción de Podcasts",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Producción de Podcasts"""
    print(f"Iniciando flujo técnico para: Producción de Podcasts")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Producción de Podcasts"}
...
**REST Endpoint:** `POST /v1/automate/101`
