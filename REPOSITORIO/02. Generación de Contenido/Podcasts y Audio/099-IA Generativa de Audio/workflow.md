---
title: Master Workflow: IA Generativa de Audio
version: 1.1
...
subcategory: General
tags: ['audio-gen-ai', 'text-to-speech', 'tts', 'voice-cloning', 'music-generation', 'suno', 'elevenlabs', 'stable-audio', 'podcast-automation']
...
# 🚀 Estrategia de Automatización: IA Generativa de Audio

Este documento define las tres vías posibles para implementar la skill de IA Generativa de Audio en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "IA Generativa de Audio",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de IA Generativa de Audio"""
    print(f"Iniciando flujo técnico para: IA Generativa de Audio")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "IA Generativa de Audio"}
...
**REST Endpoint:** `POST /v1/automate/099`
