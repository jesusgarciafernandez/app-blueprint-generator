---
title: Master Workflow: Aprendizaje Autónomo
version: 1.1
...
subcategory: General
tags: ['self-learning', 'metalearning', 'lifelong-learning', 'feynman-technique', 'knowledge-management', 'autodidaxia', 'skill-acquisition']
...
# 🚀 Estrategia de Automatización: Aprendizaje Autónomo

Este documento define las tres vías posibles para implementar la skill de Aprendizaje Autónomo en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Aprendizaje Autónomo",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Aprendizaje Autónomo"""
    print(f"Iniciando flujo técnico para: Aprendizaje Autónomo")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Aprendizaje Autónomo"}
...
**REST Endpoint:** `POST /v1/automate/464`
