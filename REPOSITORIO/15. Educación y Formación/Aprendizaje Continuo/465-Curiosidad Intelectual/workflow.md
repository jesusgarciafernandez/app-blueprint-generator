---
title: Master Workflow: Curiosidad Intelectual
version: 1.1
...
# 🚀 Estrategia de Automatización: Curiosidad Intelectual

Este documento define las tres vías posibles para implementar la skill de Curiosidad Intelectual en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Curiosidad Intelectual",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Curiosidad Intelectual"""
    print(f"Iniciando flujo técnico para: Curiosidad Intelectual")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Curiosidad Intelectual"}
...
**REST Endpoint:** `POST /v1/automate/465`
