---
title: Master Workflow: Metalearning
version: 1.1
...
subcategory: General
tags: ['metalearning', 'ultralearning', 'scott-young', 'learning-strategies', 'cognitive-science', 'skill-acquisition', 'educational-psychology']
...
# 🚀 Estrategia de Automatización: Metalearning

Este documento define las tres vías posibles para implementar la skill de Metalearning en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Metalearning"""
    print(f"Iniciando flujo técnico para: Metalearning")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Metalearning"}
...
**REST Endpoint:** `POST /v1/automate/469`
