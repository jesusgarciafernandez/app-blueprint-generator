---
title: Master Workflow: Memorización Activa
version: 1.1
...
subcategory: General
tags: ['active-recall', 'spaced-repetition', 'anki', 'memory-palace', 'long-term-memory', 'learning-science', 'metalearning']
...
# 🚀 Estrategia de Automatización: Memorización Activa

Este documento define las tres vías posibles para implementar la skill de Memorización Activa en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Memorización Activa",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Memorización Activa"""
    print(f"Iniciando flujo técnico para: Memorización Activa")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Memorización Activa"}
...
**REST Endpoint:** `POST /v1/automate/468`
