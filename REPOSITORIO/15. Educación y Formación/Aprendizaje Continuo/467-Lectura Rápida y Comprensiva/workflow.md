---
title: Master Workflow: Lectura Rápida y Comprensiva
version: 1.1
...
subcategory: General
tags: ['speed-reading', 'photo-reading', 'reading-comprehension', 'cognitive-optimization', 'skimming', 'scanning', 'metalearning']
...
# 🚀 Estrategia de Automatización: Lectura Rápida y Comprensiva

Este documento define las tres vías posibles para implementar la skill de Lectura Rápida y Comprensiva en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Lectura Rápida y Comprensiva",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Lectura Rápida y Comprensiva"""
    print(f"Iniciando flujo técnico para: Lectura Rápida y Comprensiva")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Lectura Rápida y Comprensiva"}
...
**REST Endpoint:** `POST /v1/automate/467`
