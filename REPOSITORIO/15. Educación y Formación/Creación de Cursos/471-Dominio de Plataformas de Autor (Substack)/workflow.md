---
title: Master Workflow: Dominio de Plataformas de Autor (Substack)
version: 1.1
...
subcategory: General
tags: ['substack', 'newsletter-economics', 'paid-subscriptions', 'content-monetization', 'digital-writing', 'audience-ownership', 'e-publishing', 'author-platforms']
...
# 🚀 Estrategia de Automatización: Dominio de Plataformas de Autor (Substack)

Este documento define las tres vías posibles para implementar la skill de Dominio de Plataformas de Autor (Substack) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Dominio de Plataformas de Autor (Substack)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Dominio de Plataformas de Autor (Substack)"""
    print(f"Iniciando flujo técnico para: Dominio de Plataformas de Autor (Substack)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Dominio de Plataformas de Autor (Substack)"}
...
**REST Endpoint:** `POST /v1/automate/471`
