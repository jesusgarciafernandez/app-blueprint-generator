---
title: Master Workflow: Creación de Infoproductos
version: 1.1
...
subcategory: General
tags: ['infoproducts', 'digital-learning', 'knowledge-monetization', 'instructional-design', 'course-creation', 'passive-income', 'content-strategy', 'curriculum-design']
...
# 🚀 Estrategia de Automatización: Creación de Infoproductos

Este documento define las tres vías posibles para implementar la skill de Creación de Infoproductos en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Creación de Infoproductos",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Creación de Infoproductos"""
    print(f"Iniciando flujo técnico para: Creación de Infoproductos")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Creación de Infoproductos"}
...
**REST Endpoint:** `POST /v1/automate/470`
