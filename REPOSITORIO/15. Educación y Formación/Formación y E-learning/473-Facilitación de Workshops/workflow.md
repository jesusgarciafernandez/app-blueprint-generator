---
title: Master Workflow: Facilitación de Workshops
version: 1.1
...
subcategory: General
tags: ['workshop-facilitation', 'co-creation', 'design-sprints', 'liberating-structures', 'ideation', 'group-dynamics', 'visual-facilitation', 'engagement']
...
# 🚀 Estrategia de Automatización: Facilitación de Workshops

Este documento define las tres vías posibles para implementar la skill de Facilitación de Workshops en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Facilitación de Workshops",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Facilitación de Workshops"""
    print(f"Iniciando flujo técnico para: Facilitación de Workshops")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Facilitación de Workshops"}
...
**REST Endpoint:** `POST /v1/automate/473`
