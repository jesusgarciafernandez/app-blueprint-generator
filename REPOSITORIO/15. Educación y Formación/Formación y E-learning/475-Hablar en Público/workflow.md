---
title: Master Workflow: Hablar en Público
version: 1.1
...
subcategory: General
tags: ['public-speaking', 'oratory', 'influence', 'communication', 'leadership', 'presentation-skills', 'persuasion', 'stage-presence']
...
# 🚀 Estrategia de Automatización: Hablar en Público

Este documento define las tres vías posibles para implementar la skill de Hablar en Público en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Hablar en Público",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Hablar en Público"""
    print(f"Iniciando flujo técnico para: Hablar en Público")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Hablar en Público"}
...
**REST Endpoint:** `POST /v1/automate/475`
