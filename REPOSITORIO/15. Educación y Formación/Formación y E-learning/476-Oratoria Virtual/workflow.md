---
title: Master Workflow: Oratoria Virtual
version: 1.1
...
subcategory: General
tags: ['virtual-speaking', 'video-presence', 'public-speaking', 'webinar-mastery', 'body-language', 'vocal-modulation', 'digital-charisma', 'camera-confidence']
...
# 🚀 Estrategia de Automatización: Oratoria Virtual

Este documento define las tres vías posibles para implementar la skill de Oratoria Virtual en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Oratoria Virtual"""
    print(f"Iniciando flujo técnico para: Oratoria Virtual")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Oratoria Virtual"}
...
**REST Endpoint:** `POST /v1/automate/476`
