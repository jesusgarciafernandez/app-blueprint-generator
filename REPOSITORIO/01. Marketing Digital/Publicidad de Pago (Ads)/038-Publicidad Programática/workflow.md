---
title: Master Workflow: Publicidad Programática
version: 1.1
...
subcategory: General
tags: ['programmatic-ads', 'rtb', 'dsp', 'audiencias']
...
# 🚀 Estrategia de Automatización: Publicidad Programática

Este documento define las tres vías posibles para implementar la skill de Publicidad Programática en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Publicidad Programática",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Publicidad Programática"""
    print(f"Iniciando flujo técnico para: Publicidad Programática")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Publicidad Programática"}
...
**REST Endpoint:** `POST /v1/automate/038`
