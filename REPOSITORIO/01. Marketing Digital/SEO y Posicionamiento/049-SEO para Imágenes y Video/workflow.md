---
title: Master Workflow: SEO para Imágenes y Video
version: 1.1
...
subcategory: General
tags: ['visual-seo', 'image-optimization', 'video-seo', 'web-performance']
...
# 🚀 Estrategia de Automatización: SEO para Imágenes y Video

Este documento define las tres vías posibles para implementar la skill de SEO para Imágenes y Video en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "SEO para Imágenes y Video",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de SEO para Imágenes y Video"""
    print(f"Iniciando flujo técnico para: SEO para Imágenes y Video")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "SEO para Imágenes y Video"}
...
**REST Endpoint:** `POST /v1/automate/049`
