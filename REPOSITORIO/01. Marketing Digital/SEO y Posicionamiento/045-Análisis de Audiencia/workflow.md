---
title: Master Workflow: Análisis de Audiencia
version: 1.1
...
subcategory: General
tags: ['audience-intelligence', 'analytics', 'consumer-insights', 'segmentation']
...
# 🚀 Estrategia de Automatización: Análisis de Audiencia

Este documento define las tres vías posibles para implementar la skill de Análisis de Audiencia en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Análisis de Audiencia",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Análisis de Audiencia"""
    print(f"Iniciando flujo técnico para: Análisis de Audiencia")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Análisis de Audiencia"}
...
**REST Endpoint:** `POST /v1/automate/045`
