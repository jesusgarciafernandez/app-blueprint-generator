---
title: Master Workflow: Diseño y Ejecución de Experimentos A-B (Growth Hacking)
version: 1.1
...
tags: [ab-testing, cro, growth-hacking, experimentos, analítica, conversión]
...
# 🚀 Estrategia de Automatización: Diseño y Ejecución de Experimentos A-B (Growth Hacking)

Este documento define las tres vías posibles para implementar la skill de Diseño y Ejecución de Experimentos A-B (Growth Hacking) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Diseño y Ejecución de Experimentos A-B (Growth Hacking)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Diseño y Ejecución de Experimentos A-B (Growth Hacking)"""
    print(f"Iniciando flujo técnico para: Diseño y Ejecución de Experimentos A-B (Growth Hacking)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Diseño y Ejecución de Experimentos A-B (Growth Hacking)"}
...
**REST Endpoint:** `POST /v1/automate/009`
