---
title: Master Workflow: Gestión de Community Management
version: 1.1
...
subcategory: General
tags: [social-media, marketing, auto-post]
...
# 🚀 Estrategia de Automatización: Gestión de Community Management

Este documento define las tres vías posibles para implementar la skill de Gestión de Community Management en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de Community Management",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de Community Management"""
    print(f"Iniciando flujo técnico para: Gestión de Community Management")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de Community Management"}
...
**REST Endpoint:** `POST /v1/automate/029`
