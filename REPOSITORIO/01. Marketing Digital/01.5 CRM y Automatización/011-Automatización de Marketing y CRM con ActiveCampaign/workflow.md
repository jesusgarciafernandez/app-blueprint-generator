---
title: Master Workflow: Automatización de Marketing y CRM con ActiveCampaign
version: 1.1
...
tags: [crm, email-marketing, automatización, activecampaign, sales-pipeline, leads]
...
# 🚀 Estrategia de Automatización: Automatización de Marketing y CRM con ActiveCampaign

Este documento define las tres vías posibles para implementar la skill de Automatización de Marketing y CRM con ActiveCampaign en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Automatización de Marketing y CRM con ActiveCampaign",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Automatización de Marketing y CRM con ActiveCampaign"""
    print(f"Iniciando flujo técnico para: Automatización de Marketing y CRM con ActiveCampaign")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Automatización de Marketing y CRM con ActiveCampaign"}
...
**REST Endpoint:** `POST /v1/automate/011`
