...
1.  **Analiza la Carga Cognitiva:** ¿Cuántas decisiones le pides al usuario en cada pantalla?
2.  **Identifica Fugas de Confianza:** ¿Faltan sellos de seguridad, testimonios reales o garantías claras?
...
1.  **Trigger:** El sistema detecta que un usuario pasa mucho tiempo en la página de precios sin hacer clic (Duda).
2.  **Nodo de Disparo:** Activación de un disparador de "Prueba Social Dinámica" (Ej: "X personas están viendo este plan ahora").
3.  **Nodo de Rescate:** Si el usuario amaga con salir, ofrecer un "Incentivo de Reciprocidad" (Ej: Una guía gratuita de valor inmediato).
4.  **Nodo de Aprendizaje:** El sistema registra qué disparador psicológico ha funcionado mejor para ese perfil de usuario.
5.  **Output:** Incremento del ratio de conversión asistida por IA conductual.
