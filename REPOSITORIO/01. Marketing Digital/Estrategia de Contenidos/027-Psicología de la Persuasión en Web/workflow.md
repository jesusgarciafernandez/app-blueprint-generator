---
title: Master Workflow: Psicología de la Persuasión en Web
version: 1.1
...
subcategory: General
tags: ['conversion-psychology', 'behavioral-science', 'cialdini-principles', 'neuromarketing']
...
# 🚀 Estrategia de Automatización: Psicología de la Persuasión en Web

Este documento define las tres vías posibles para implementar la skill de Psicología de la Persuasión en Web en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Psicología de la Persuasión en Web",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Psicología de la Persuasión en Web"""
    print(f"Iniciando flujo técnico para: Psicología de la Persuasión en Web")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Psicología de la Persuasión en Web"}
...
**REST Endpoint:** `POST /v1/automate/027`
