...
1.  **Analiza la Voz del Cliente:** Extrae los 5 problemas más frustrantes de la audiencia.
2.  **Identifica los Aliviadores de Dolor:** ¿Cómo tu producto detiene ese sufrimiento?
...
1.  **Trigger:** Informe de análisis de competencia detecta un nuevo competidor con una oferta similar.
2.  **Nodo de Auditoría:** IA compara nuestra UVP con la del nuevo rival.
3.  **Nodo de Sugerencia:** Adaptación del mensaje para resaltar lo que ellos no tienen (Diferenciador).
4.  **Nodo de Distribución:** Actualización automática del "Hero Section" en el Blueprint de la web.
5.  **Output:** Nueva narrativa de ventas lista para ser comunicada al equipo.
