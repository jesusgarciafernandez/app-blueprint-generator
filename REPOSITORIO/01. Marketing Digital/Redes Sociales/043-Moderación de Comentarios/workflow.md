---
title: Master Workflow: Moderación de Comentarios
version: 1.1
...
# 🚀 Estrategia de Automatización: Moderación de Comentarios

Este documento define las tres vías posibles para implementar la skill de Moderación de Comentarios en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Moderación de Comentarios",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Moderación de Comentarios"""
    print(f"Iniciando flujo técnico para: Moderación de Comentarios")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Moderación de Comentarios"}
...
**REST Endpoint:** `POST /v1/automate/043`
