---
title: Master Workflow: Comunicación Asertiva
version: 1.1
...
subcategory: General
tags: ['asertividad', 'comunicación-efectiva', 'soft-skills', 'límites', 'claridad', 'influencia', 'leadership', 'conflict-management']
...
# 🚀 Estrategia de Automatización: Comunicación Asertiva

Este documento define las tres vías posibles para implementar la skill de Comunicación Asertiva en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Comunicación Asertiva",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Comunicación Asertiva"""
    print(f"Iniciando flujo técnico para: Comunicación Asertiva")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Comunicación Asertiva"}
...
**REST Endpoint:** `POST /v1/automate/280`
