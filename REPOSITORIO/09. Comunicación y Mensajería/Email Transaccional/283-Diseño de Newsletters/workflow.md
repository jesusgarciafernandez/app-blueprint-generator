---
title: Master Workflow: Diseño de Newsletters
version: 1.1
...
subcategory: General
tags: ['newsletter-design', 'email-marketing', 'content-curation', 'subscriber-engagement', 'layout-design', 'copywriting', 'personalization', 'monetization']
...
# 🚀 Estrategia de Automatización: Diseño de Newsletters

Este documento define las tres vías posibles para implementar la skill de Diseño de Newsletters en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Diseño de Newsletters",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Diseño de Newsletters"""
    print(f"Iniciando flujo técnico para: Diseño de Newsletters")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Diseño de Newsletters"}
...
**REST Endpoint:** `POST /v1/automate/283`
