---
title: Master Workflow: Automatización de Comunicaciones Inteligentes vía Email
version: 1.1
...
subcategory: 09.2 Email Marketing
tags: [email, comunicación, ia, automatización, personalización, engagement]
...
# 🚀 Estrategia de Automatización: Automatización de Comunicaciones Inteligentes vía Email

Este documento define las tres vías posibles para implementar la skill de Automatización de Comunicaciones Inteligentes vía Email en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Automatización de Comunicaciones Inteligentes vía Email",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Automatización de Comunicaciones Inteligentes vía Email"""
    print(f"Iniciando flujo técnico para: Automatización de Comunicaciones Inteligentes vía Email")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Automatización de Comunicaciones Inteligentes vía Email"}
...
**REST Endpoint:** `POST /v1/automate/277`
