---
title: Master Workflow: Gestión de Micro-comunidades
version: 1.1
...
# 🚀 Estrategia de Automatización: Gestión de Micro-comunidades

Este documento define las tres vías posibles para implementar la skill de Gestión de Micro-comunidades en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de Micro-comunidades",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de Micro-comunidades"""
    print(f"Iniciando flujo técnico para: Gestión de Micro-comunidades")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de Micro-comunidades"}
...
**REST Endpoint:** `POST /v1/automate/285`
