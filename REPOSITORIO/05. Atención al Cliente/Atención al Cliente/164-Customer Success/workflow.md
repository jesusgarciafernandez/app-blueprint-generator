---
title: Master Workflow: Customer Success
version: 1.1
...
subcategory: General
tags: ['customer-success', 'retention', 'saas-metrics', 'onboarding', 'churn-reduction', 'customer-health-score', 'upselling', 'loyalty']
...
# 🚀 Estrategia de Automatización: Customer Success

Este documento define las tres vías posibles para implementar la skill de Customer Success en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Customer Success"""
    print(f"Iniciando flujo técnico para: Customer Success")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Customer Success"}
...
**REST Endpoint:** `POST /v1/automate/164`
