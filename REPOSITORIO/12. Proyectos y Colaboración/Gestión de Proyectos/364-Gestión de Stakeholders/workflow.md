---
title: Master Workflow: Gestión de Stakeholders
version: 1.1
...
# 🚀 Estrategia de Automatización: Gestión de Stakeholders

Este documento define las tres vías posibles para implementar la skill de Gestión de Stakeholders en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de Stakeholders",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de Stakeholders"""
    print(f"Iniciando flujo técnico para: Gestión de Stakeholders")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de Stakeholders"}
...
**REST Endpoint:** `POST /v1/automate/364`
