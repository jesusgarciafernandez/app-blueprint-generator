---
title: Master Workflow: Gestión de la Incertidumbre
version: 1.1
...
# 🚀 Estrategia de Automatización: Gestión de la Incertidumbre

Este documento define las tres vías posibles para implementar la skill de Gestión de la Incertidumbre en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de la Incertidumbre",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de la Incertidumbre"""
    print(f"Iniciando flujo técnico para: Gestión de la Incertidumbre")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de la Incertidumbre"}
...
**REST Endpoint:** `POST /v1/automate/366`
