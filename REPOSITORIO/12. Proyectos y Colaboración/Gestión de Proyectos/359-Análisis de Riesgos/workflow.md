---
title: Master Workflow: Análisis de Riesgos
version: 1.1
...
# 🚀 Estrategia de Automatización: Análisis de Riesgos

Este documento define las tres vías posibles para implementar la skill de Análisis de Riesgos en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Análisis de Riesgos",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Análisis de Riesgos"""
    print(f"Iniciando flujo técnico para: Análisis de Riesgos")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Análisis de Riesgos"}
...
**REST Endpoint:** `POST /v1/automate/359`
