---
title: Master Workflow: Liderazgo de Equipos Remotos
version: 1.1
...
# 🚀 Estrategia de Automatización: Liderazgo de Equipos Remotos

Este documento define las tres vías posibles para implementar la skill de Liderazgo de Equipos Remotos en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Liderazgo de Equipos Remotos",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Liderazgo de Equipos Remotos"""
    print(f"Iniciando flujo técnico para: Liderazgo de Equipos Remotos")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Liderazgo de Equipos Remotos"}
...
**REST Endpoint:** `POST /v1/automate/368`
