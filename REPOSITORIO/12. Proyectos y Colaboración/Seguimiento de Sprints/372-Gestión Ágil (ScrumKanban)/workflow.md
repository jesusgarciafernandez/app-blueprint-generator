---
title: Master Workflow: Gestión Ágil (ScrumKanban)
version: 1.1
...
# 🚀 Estrategia de Automatización: Gestión Ágil (ScrumKanban)

Este documento define las tres vías posibles para implementar la skill de Gestión Ágil (ScrumKanban) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión Ágil (ScrumKanban)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión Ágil (ScrumKanban)"""
    print(f"Iniciando flujo técnico para: Gestión Ágil (ScrumKanban)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión Ágil (ScrumKanban)"}
...
**REST Endpoint:** `POST /v1/automate/372`
