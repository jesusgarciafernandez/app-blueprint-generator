---
title: Master Workflow: Inteligencia Colectiva
version: 1.1
...
subcategory: General
tags: ['collective-intelligence', 'crowdsourcing', 'collaborative-problem-solving', 'wisdom-of-crowds', 'open-innovation', 'swarm-intelligence', 'networked-knowledge', 'civic-engagement']
...
# 🚀 Estrategia de Automatización: Inteligencia Colectiva

Este documento define las tres vías posibles para implementar la skill de Inteligencia Colectiva en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Inteligencia Colectiva",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Inteligencia Colectiva"""
    print(f"Iniciando flujo técnico para: Inteligencia Colectiva")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Inteligencia Colectiva"}
...
**REST Endpoint:** `POST /v1/automate/553`
