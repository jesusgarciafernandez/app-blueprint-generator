---
title: Master Workflow: Investigación de Mercado
version: 1.1
...
subcategory: General
tags: ['market-research', 'consumer-insights', 'data-analysis', 'audience-intelligence', 'market-fit']
...
# 🚀 Estrategia de Automatización: Investigación de Mercado

Este documento define las tres vías posibles para implementar la skill de Investigación de Mercado en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Investigación de Mercado",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Investigación de Mercado"""
    print(f"Iniciando flujo técnico para: Investigación de Mercado")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Investigación de Mercado"}
...
**REST Endpoint:** `POST /v1/automate/548`
