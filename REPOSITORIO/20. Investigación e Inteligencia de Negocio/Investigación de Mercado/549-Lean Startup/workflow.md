---
title: Master Workflow: Lean Startup
version: 1.1
...
subcategory: General
tags: ['lean-startup', 'mvp', 'build-measure-learn', 'pivot', 'validation', 'hypothesis-testing', 'agile-development', 'product-market-fit']
...
# 🚀 Estrategia de Automatización: Lean Startup

Este documento define las tres vías posibles para implementar la skill de Lean Startup en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Lean Startup"""
    print(f"Iniciando flujo técnico para: Lean Startup")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Lean Startup"}
...
**REST Endpoint:** `POST /v1/automate/549`
