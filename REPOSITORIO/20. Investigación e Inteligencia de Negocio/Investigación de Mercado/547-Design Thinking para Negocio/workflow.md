---
title: Master Workflow: Design Thinking para Negocio
version: 1.1
...
subcategory: General
tags: ['design-thinking', 'innovation', 'user-centric', 'ideation', 'prototyping', 'empathy', 'business-strategy', 'problem-solving']
...
# 🚀 Estrategia de Automatización: Design Thinking para Negocio

Este documento define las tres vías posibles para implementar la skill de Design Thinking para Negocio en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Design Thinking para Negocio",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Design Thinking para Negocio"""
    print(f"Iniciando flujo técnico para: Design Thinking para Negocio")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Design Thinking para Negocio"}
...
**REST Endpoint:** `POST /v1/automate/547`
