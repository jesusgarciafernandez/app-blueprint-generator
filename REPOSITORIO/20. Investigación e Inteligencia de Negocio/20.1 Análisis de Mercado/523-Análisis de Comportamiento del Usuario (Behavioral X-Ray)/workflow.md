---
title: Master Workflow: Análisis de Comportamiento del Usuario (Behavioral X-Ray)
version: 1.1
...
tags: [behavioral, ux, hotjar, clarity, insights, psicología, comportamiento]
...
# 🚀 Estrategia de Automatización: Análisis de Comportamiento del Usuario (Behavioral X-Ray)

Este documento define las tres vías posibles para implementar la skill de Análisis de Comportamiento del Usuario (Behavioral X-Ray) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Análisis de Comportamiento del Usuario (Behavioral X-Ray)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Análisis de Comportamiento del Usuario (Behavioral X-Ray)"""
    print(f"Iniciando flujo técnico para: Análisis de Comportamiento del Usuario (Behavioral X-Ray)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Análisis de Comportamiento del Usuario (Behavioral X-Ray)"}
...
**REST Endpoint:** `POST /v1/automate/523`
