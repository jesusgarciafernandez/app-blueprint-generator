---
title: Master Workflow: Alfabetización Mediática
version: 1.1
...
subcategory: General
tags: ['media-literacy', 'fact-checking', 'information-hygiene', 'disinformation-defense', 'critical-thinking', 'fake-news-detection', 'propaganda-analysis', 'digital-citizenship']
...
# 🚀 Estrategia de Automatización: Alfabetización Mediática

Este documento define las tres vías posibles para implementar la skill de Alfabetización Mediática en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Alfabetización Mediática",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Alfabetización Mediática"""
    print(f"Iniciando flujo técnico para: Alfabetización Mediática")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Alfabetización Mediática"}
...
**REST Endpoint:** `POST /v1/automate/554`
