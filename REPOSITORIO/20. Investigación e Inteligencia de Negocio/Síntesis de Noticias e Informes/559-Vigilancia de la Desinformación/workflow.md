---
title: Master Workflow: Vigilancia de la Desinformación
version: 1.1
...
subcategory: General
tags: ['disinformation-defense', 'fake-news-detection', 'deepfake-vigilance', 'information-warfare', 'osint', 'fact-checking-systems', 'media-forensics', 'reputation-protection']
...
# 🚀 Estrategia de Automatización: Vigilancia de la Desinformación

Este documento define las tres vías posibles para implementar la skill de Vigilancia de la Desinformación en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Vigilancia de la Desinformación",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Vigilancia de la Desinformación"""
    print(f"Iniciando flujo técnico para: Vigilancia de la Desinformación")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Vigilancia de la Desinformación"}
...
**REST Endpoint:** `POST /v1/automate/559`
