---
title: Master Workflow: Inteligencia de Negocios (BI)
version: 1.1
...
subcategory: General
tags: ['business-intelligence', 'bi', 'dashboards', 'kpi', 'data-warehousing', 'etl', 'decision-making', 'strategic-analysis']
...
# 🚀 Estrategia de Automatización: Inteligencia de Negocios (BI)

Este documento define las tres vías posibles para implementar la skill de Inteligencia de Negocios (BI) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Inteligencia de Negocios (BI)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Inteligencia de Negocios (BI)"""
    print(f"Iniciando flujo técnico para: Inteligencia de Negocios (BI)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Inteligencia de Negocios (BI)"}
...
**REST Endpoint:** `POST /v1/automate/557`
