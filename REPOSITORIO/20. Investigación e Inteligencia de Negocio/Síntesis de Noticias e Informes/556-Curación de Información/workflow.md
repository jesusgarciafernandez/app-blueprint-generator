---
title: Master Workflow: Curación de Información
version: 1.1
...
subcategory: General
tags: ['content-curation', 'information-overload', 'personal-knowledge-management', 'rss', 'filtering', 'ai-synthesis', 'critical-thinking']
...
# 🚀 Estrategia de Automatización: Curación de Información

Este documento define las tres vías posibles para implementar la skill de Curación de Información en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Curación de Información",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Curación de Información"""
    print(f"Iniciando flujo técnico para: Curación de Información")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Curación de Información"}
...
**REST Endpoint:** `POST /v1/automate/556`
