---
title: Master Workflow: Narrativa de Datos: Historias Accionables
version: 1.1
...
subcategory: 20.3 Visualización de Datos
tags: [data-storytelling, datos, comunicación, narrativa, visualización, persuasión]
...
# 🚀 Estrategia de Automatización: Narrativa de Datos: Historias Accionables

Este documento define las tres vías posibles para implementar la skill de Narrativa de Datos: Historias Accionables en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Narrativa de Datos: Historias Accionables",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Narrativa de Datos: Historias Accionables"""
    print(f"Iniciando flujo técnico para: Narrativa de Datos: Historias Accionables")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Narrativa de Datos: Historias Accionables"}
...
**REST Endpoint:** `POST /v1/automate/527`
