---
title: Master Workflow: Pensamiento de Largo Plazo (Long-termism)
version: 1.1
...
subcategory: General
tags: ['long-termism', 'existential-risk', 'future-generations', 'intergenerational-fairness', 'strategic-foresight', 'catastrophic-risk-mitigation', 'deep-time', 'stewardship']
...
# 🚀 Estrategia de Automatización: Pensamiento de Largo Plazo (Long-termism)

Este documento define las tres vías posibles para implementar la skill de Pensamiento de Largo Plazo (Long-termism) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Pensamiento de Largo Plazo (Long-termism)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Pensamiento de Largo Plazo (Long-termism)"""
    print(f"Iniciando flujo técnico para: Pensamiento de Largo Plazo (Long-termism)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Pensamiento de Largo Plazo (Long-termism)"}
...
**REST Endpoint:** `POST /v1/automate/542`
