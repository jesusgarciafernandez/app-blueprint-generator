---
title: Master Workflow: Modelado Mental
version: 1.1
...
subcategory: General
tags: ['mental-models', 'charlie-munger', 'latticework', 'critical-thinking', 'decision-making', 'systems-thinking', 'strategy']
...
# 🚀 Estrategia de Automatización: Modelado Mental

Este documento define las tres vías posibles para implementar la skill de Modelado Mental en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Modelado Mental"""
    print(f"Iniciando flujo técnico para: Modelado Mental")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Modelado Mental"}
...
**REST Endpoint:** `POST /v1/automate/538`
