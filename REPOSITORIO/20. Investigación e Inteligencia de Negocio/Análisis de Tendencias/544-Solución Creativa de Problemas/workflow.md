---
title: Master Workflow: Solución Creativa de Problemas
version: 1.1
...
subcategory: General
tags: ['problem-solving', 'creative-thinking', 'design-thinking', 'lateral-thinking', 'innovation', 'ideation', 'root-cause-analysis', 'strategic-creativity']
...
# 🚀 Estrategia de Automatización: Solución Creativa de Problemas

Este documento define las tres vías posibles para implementar la skill de Solución Creativa de Problemas en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Solución Creativa de Problemas",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Solución Creativa de Problemas"""
    print(f"Iniciando flujo técnico para: Solución Creativa de Problemas")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Solución Creativa de Problemas"}
...
**REST Endpoint:** `POST /v1/automate/544`
