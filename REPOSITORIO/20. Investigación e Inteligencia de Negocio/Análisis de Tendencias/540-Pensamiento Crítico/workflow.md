---
title: Master Workflow: Pensamiento Crítico
version: 1.1
...
subcategory: General
tags: ['critical-thinking', 'analysis', 'logic', 'problem-solving', 'decision-making', 'bias-detection', 'strategic-thinking', 'intellectual-humility']
...
# 🚀 Estrategia de Automatización: Pensamiento Crítico

Este documento define las tres vías posibles para implementar la skill de Pensamiento Crítico en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Pensamiento Crítico",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Pensamiento Crítico"""
    print(f"Iniciando flujo técnico para: Pensamiento Crítico")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Pensamiento Crítico"}
...
**REST Endpoint:** `POST /v1/automate/540`
