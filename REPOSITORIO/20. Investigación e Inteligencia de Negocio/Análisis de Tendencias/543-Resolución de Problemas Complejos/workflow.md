---
title: Master Workflow: Resolución de Problemas Complejos
version: 1.1
...
subcategory: General
tags: ['complex-problem-solving', 'critical-thinking', 'design-thinking', 'systems-thinking', 'root-cause-analysis', 'innovation', 'logic', 'strategic-analysis']
...
# 🚀 Estrategia de Automatización: Resolución de Problemas Complejos

Este documento define las tres vías posibles para implementar la skill de Resolución de Problemas Complejos en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Resolución de Problemas Complejos",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Resolución de Problemas Complejos"""
    print(f"Iniciando flujo técnico para: Resolución de Problemas Complejos")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Resolución de Problemas Complejos"}
...
**REST Endpoint:** `POST /v1/automate/543`
