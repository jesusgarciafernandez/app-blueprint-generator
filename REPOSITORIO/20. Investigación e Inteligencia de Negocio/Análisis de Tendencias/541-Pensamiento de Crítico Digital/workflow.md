---
title: Master Workflow: Pensamiento de Crítico Digital
version: 1.1
...
subcategory: General
tags: ['critical-thinking', 'digital-literacy', 'fact-checking', 'information-hygiene', 'cognitive-bias', 'misinformation', 'digital-verification', 'analytical-skills']
...
# 🚀 Estrategia de Automatización: Pensamiento de Crítico Digital

Este documento define las tres vías posibles para implementar la skill de Pensamiento de Crítico Digital en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Pensamiento de Crítico Digital",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Pensamiento de Crítico Digital"""
    print(f"Iniciando flujo técnico para: Pensamiento de Crítico Digital")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Pensamiento de Crítico Digital"}
...
**REST Endpoint:** `POST /v1/automate/541`
