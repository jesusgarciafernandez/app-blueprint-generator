---
title: Master Workflow: Crowdsourcing
version: 1.1
...
subcategory: General
tags: ['crowdsourcing', 'collective-intelligence', 'co-creation', 'open-innovation', 'community-engagement', 'product-development', 'feedback-loop', 'distributed-problem-solving']
...
# 🚀 Estrategia de Automatización: Crowdsourcing

Este documento define las tres vías posibles para implementar la skill de Crowdsourcing en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Crowdsourcing"""
    print(f"Iniciando flujo técnico para: Crowdsourcing")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Crowdsourcing"}
...
**REST Endpoint:** `POST /v1/automate/532`
