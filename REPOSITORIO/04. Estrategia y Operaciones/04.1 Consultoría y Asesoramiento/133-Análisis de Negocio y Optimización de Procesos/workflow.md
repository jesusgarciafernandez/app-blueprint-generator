---
title: Master Workflow: Análisis de Negocio y Optimización de Procesos
version: 1.1
...
tags: [análisis-negocio, procesos, optimización, eficiencia, consultoría, bpa]
...
# 🚀 Estrategia de Automatización: Análisis de Negocio y Optimización de Procesos

Este documento define las tres vías posibles para implementar la skill de Análisis de Negocio y Optimización de Procesos en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Análisis de Negocio y Optimización de Procesos",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Análisis de Negocio y Optimización de Procesos"""
    print(f"Iniciando flujo técnico para: Análisis de Negocio y Optimización de Procesos")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Análisis de Negocio y Optimización de Procesos"}
...
**REST Endpoint:** `POST /v1/automate/133`
