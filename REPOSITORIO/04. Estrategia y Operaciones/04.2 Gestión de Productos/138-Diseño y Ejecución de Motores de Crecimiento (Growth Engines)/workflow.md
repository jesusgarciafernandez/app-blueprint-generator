---
title: Master Workflow: Diseño y Ejecución de Motores de Crecimiento (Growth Engines)
version: 1.1
...
tags: [growth, producto, marketing, bucles, escalado, experimentos, ltv]
...
# 🚀 Estrategia de Automatización: Diseño y Ejecución de Motores de Crecimiento (Growth Engines)

Este documento define las tres vías posibles para implementar la skill de Diseño y Ejecución de Motores de Crecimiento (Growth Engines) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Diseño y Ejecución de Motores de Crecimiento (Growth Engines)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Diseño y Ejecución de Motores de Crecimiento (Growth Engines)"""
    print(f"Iniciando flujo técnico para: Diseño y Ejecución de Motores de Crecimiento (Growth Engines)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Diseño y Ejecución de Motores de Crecimiento (Growth Engines)"}
...
**REST Endpoint:** `POST /v1/automate/138`
