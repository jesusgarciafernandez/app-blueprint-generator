---
title: Master Workflow: Auditoría de Algoritmos Forense
version: 1.1
...
subcategory: General
tags: ['algorithmic-forensics', 'ai-auditing', 'model-explainability', 'xai', 'root-cause-analysis', 'algorithmic-accountability', 'bias-detection', 'ai-incident-response']
...
# 🚀 Estrategia de Automatización: Auditoría de Algoritmos Forense

Este documento define las tres vías posibles para implementar la skill de Auditoría de Algoritmos Forense en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Auditoría de Algoritmos Forense",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Auditoría de Algoritmos Forense"""
    print(f"Iniciando flujo técnico para: Auditoría de Algoritmos Forense")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Auditoría de Algoritmos Forense"}
...
**REST Endpoint:** `POST /v1/automate/435`
