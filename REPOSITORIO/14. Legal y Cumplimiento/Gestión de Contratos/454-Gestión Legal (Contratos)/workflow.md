---
title: Master Workflow: Gestión Legal (Contratos)
version: 1.1
...
subcategory: General
tags: ['contract-management', 'legal-ops', 'risk-mitigation', 'compliance', 'negotiation', 'digital-signature', 'legal-tech']
...
# 🚀 Estrategia de Automatización: Gestión Legal (Contratos)

Este documento define las tres vías posibles para implementar la skill de Gestión Legal (Contratos) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión Legal (Contratos)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión Legal (Contratos)"""
    print(f"Iniciando flujo técnico para: Gestión Legal (Contratos)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión Legal (Contratos)"}
...
**REST Endpoint:** `POST /v1/automate/454`
