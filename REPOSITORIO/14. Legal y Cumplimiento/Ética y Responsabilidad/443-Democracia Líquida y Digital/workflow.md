---
title: Master Workflow: Democracia Líquida y Digital
version: 1.1
...
subcategory: General
tags: ['liquid-democracy', 'digital-governance', 'blockchain-voting', 'delegative-democracy', 'dao', 'civic-tech', 'e-participation', 'collective-intelligence']
...
# 🚀 Estrategia de Automatización: Democracia Líquida y Digital

Este documento define las tres vías posibles para implementar la skill de Democracia Líquida y Digital en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Democracia Líquida y Digital",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Democracia Líquida y Digital"""
    print(f"Iniciando flujo técnico para: Democracia Líquida y Digital")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Democracia Líquida y Digital"}
...
**REST Endpoint:** `POST /v1/automate/443`
