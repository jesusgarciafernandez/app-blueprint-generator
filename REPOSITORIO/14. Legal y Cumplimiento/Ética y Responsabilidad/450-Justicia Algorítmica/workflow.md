---
title: Master Workflow: Justicia Algorítmica
version: 1.1
...
subcategory: General
tags: ['algorithmic-justice', 'ai-fairness', 'bias-mitigation', 'debiased-ai', 'social-scoring-ethics', 'predictive-policing-critique', 'automated-discrimination', 'judicial-tech-ethics']
...
# 🚀 Estrategia de Automatización: Justicia Algorítmica

Este documento define las tres vías posibles para implementar la skill de Justicia Algorítmica en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Justicia Algorítmica",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Justicia Algorítmica"""
    print(f"Iniciando flujo técnico para: Justicia Algorítmica")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Justicia Algorítmica"}
...
**REST Endpoint:** `POST /v1/automate/450`
