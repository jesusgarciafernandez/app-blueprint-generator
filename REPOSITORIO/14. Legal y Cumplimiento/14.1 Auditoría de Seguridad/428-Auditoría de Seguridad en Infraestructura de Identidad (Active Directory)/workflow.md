---
title: Master Workflow: Auditoría de Seguridad en Infraestructura de Identidad (Active Directory)
version: 1.1
...
tags: [seguridad, active-directory, identidad, riesgos, auditoría, defensa]
...
# 🚀 Estrategia de Automatización: Auditoría de Seguridad en Infraestructura de Identidad (Active Directory)

Este documento define las tres vías posibles para implementar la skill de Auditoría de Seguridad en Infraestructura de Identidad (Active Directory) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Auditoría de Seguridad en Infraestructura de Identidad (Active Directory)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Auditoría de Seguridad en Infraestructura de Identidad (Active Directory)"""
    print(f"Iniciando flujo técnico para: Auditoría de Seguridad en Infraestructura de Identidad (Active Directory)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Auditoría de Seguridad en Infraestructura de Identidad (Active Directory)"}
...
**REST Endpoint:** `POST /v1/automate/428`
