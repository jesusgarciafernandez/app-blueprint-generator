---
title: Master Workflow: Data Governance
version: 1.1
...
subcategory: General
tags: ['data-governance', 'data-quality', 'master-data', 'metadata', 'compliance', 'data-lineage', 'privacy', 'dg-policy']
...
# 🚀 Estrategia de Automatización: Data Governance

Este documento define las tres vías posibles para implementar la skill de Data Governance en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Data Governance"""
    print(f"Iniciando flujo técnico para: Data Governance")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Data Governance"}
...
**REST Endpoint:** `POST /v1/automate/456`
