---
title: Master Workflow: Gestión de Catálogos de Datos
version: 1.1
...
subcategory: General
tags: ['data-catalog', 'metadata-management', 'data-governance', 'data-stewardship', 'data-lineage', 'compliance', 'data-discovery']
...
# 🚀 Estrategia de Automatización: Gestión de Catálogos de Datos

Este documento define las tres vías posibles para implementar la skill de Gestión de Catálogos de Datos en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de Catálogos de Datos",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de Catálogos de Datos"""
    print(f"Iniciando flujo técnico para: Gestión de Catálogos de Datos")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de Catálogos de Datos"}
...
**REST Endpoint:** `POST /v1/automate/458`
