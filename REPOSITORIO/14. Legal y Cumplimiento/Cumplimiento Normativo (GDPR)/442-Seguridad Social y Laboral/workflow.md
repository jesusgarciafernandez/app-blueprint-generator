---
title: Master Workflow: Seguridad Social y Laboral
version: 1.1
...
subcategory: General
tags: ['labor-law', 'social-security', 'payroll-compliance', 'employment-contracts', 'worker-rights', 'hr-compliance', 'labor-relations', 'social-contributions']
...
# 🚀 Estrategia de Automatización: Seguridad Social y Laboral

Este documento define las tres vías posibles para implementar la skill de Seguridad Social y Laboral en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Seguridad Social y Laboral",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Seguridad Social y Laboral"""
    print(f"Iniciando flujo técnico para: Seguridad Social y Laboral")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Seguridad Social y Laboral"}
...
**REST Endpoint:** `POST /v1/automate/442`
