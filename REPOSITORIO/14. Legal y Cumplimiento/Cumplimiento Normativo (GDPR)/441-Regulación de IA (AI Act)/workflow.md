---
title: Master Workflow: Regulación de IA (AI Act)
version: 1.1
...
subcategory: General
tags: ['ai-act', 'compliance', 'regulation', 'ethics', 'risk-management', 'governance', 'eu-law', 'audit']
...
# 🚀 Estrategia de Automatización: Regulación de IA (AI Act)

Este documento define las tres vías posibles para implementar la skill de Regulación de IA (AI Act) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Regulación de IA (AI Act)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Regulación de IA (AI Act)"""
    print(f"Iniciando flujo técnico para: Regulación de IA (AI Act)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Regulación de IA (AI Act)"}
...
**REST Endpoint:** `POST /v1/automate/441`
