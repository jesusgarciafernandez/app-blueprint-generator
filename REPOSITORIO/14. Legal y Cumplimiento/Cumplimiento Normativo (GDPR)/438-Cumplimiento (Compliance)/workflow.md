---
title: Master Workflow: Cumplimiento (Compliance)
version: 1.1
...
subcategory: General
tags: ['compliance', 'regulatory-affairs', 'anti-bribery', 'data-protection', 'ethics', 'risk-management', 'kyc', 'aml']
...
# 🚀 Estrategia de Automatización: Cumplimiento (Compliance)

Este documento define las tres vías posibles para implementar la skill de Cumplimiento (Compliance) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Cumplimiento (Compliance)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Cumplimiento (Compliance)"""
    print(f"Iniciando flujo técnico para: Cumplimiento (Compliance)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Cumplimiento (Compliance)"}
...
**REST Endpoint:** `POST /v1/automate/438`
