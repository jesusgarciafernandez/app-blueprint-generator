---
title: Master Workflow: Auto-cuidado (Self-care)
version: 1.1
...
subcategory: General
tags: ['self-care', 'burnout-prevention', 'wellbeing', 'mental-health', 'professional-sustainability', 'energy-management', 'resilience']
...
# 🚀 Estrategia de Automatización: Auto-cuidado (Self-care)

Este documento define las tres vías posibles para implementar la skill de Auto-cuidado (Self-care) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Auto-cuidado (Self-care)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Auto-cuidado (Self-care)"""
    print(f"Iniciando flujo técnico para: Auto-cuidado (Self-care)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Auto-cuidado (Self-care)"}
...
**REST Endpoint:** `POST /v1/automate/484`
