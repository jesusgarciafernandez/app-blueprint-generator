---
title: Master Workflow: Bioinformática
version: 1.1
...
subcategory: General
tags: ['bioinformatics', 'genomics', 'proteomics', 'computational-biology', 'biostatistics', 'sequence-analysis', 'dna-sequencing', 'biotech']
...
# 🚀 Estrategia de Automatización: Bioinformática

Este documento define las tres vías posibles para implementar la skill de Bioinformática en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Bioinformática"""
    print(f"Iniciando flujo técnico para: Bioinformática")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Bioinformática"}
...
**REST Endpoint:** `POST /v1/automate/491`
