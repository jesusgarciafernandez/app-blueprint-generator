---
title: Master Workflow: Extracción Inteligente OCR LLM para Facturas
version: 1.1
...
# 🚀 Estrategia de Automatización: Extracción Inteligente OCR LLM para Facturas

Este documento define las tres vías posibles para implementar la skill de Extracción Inteligente OCR LLM para Facturas en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Extracción Inteligente OCR LLM para Facturas",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Extracción Inteligente OCR LLM para Facturas"""
    print(f"Iniciando flujo técnico para: Extracción Inteligente OCR LLM para Facturas")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Extracción Inteligente OCR LLM para Facturas"}
...
**REST Endpoint:** `POST /v1/automate/337`
