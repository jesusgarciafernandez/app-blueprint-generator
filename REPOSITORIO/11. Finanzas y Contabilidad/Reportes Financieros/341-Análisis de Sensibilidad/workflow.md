---
title: Master Workflow: Análisis de Sensibilidad
version: 1.1
...
subcategory: General
tags: ['sensitivity-analysis', 'financial-modeling', 'risk-assessment', 'decision-support', 'what-if-scenarios', 'business-intelligence', 'profitability-analysis', 'uncertainty-management']
...
# 🚀 Estrategia de Automatización: Análisis de Sensibilidad

Este documento define las tres vías posibles para implementar la skill de Análisis de Sensibilidad en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Análisis de Sensibilidad",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Análisis de Sensibilidad"""
    print(f"Iniciando flujo técnico para: Análisis de Sensibilidad")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Análisis de Sensibilidad"}
...
**REST Endpoint:** `POST /v1/automate/341`
