---
title: Master Workflow: Auditoría Financiera
version: 1.1
...
subcategory: General
tags: ['audit', 'financial-audit', 'compliance', 'internal-control', 'tax-compliance', 'fraud-detection', 'accounting-standards', 'transparency']
...
# 🚀 Estrategia de Automatización: Auditoría Financiera

Este documento define las tres vías posibles para implementar la skill de Auditoría Financiera en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Auditoría Financiera",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Auditoría Financiera"""
    print(f"Iniciando flujo técnico para: Auditoría Financiera")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Auditoría Financiera"}
...
**REST Endpoint:** `POST /v1/automate/342`
