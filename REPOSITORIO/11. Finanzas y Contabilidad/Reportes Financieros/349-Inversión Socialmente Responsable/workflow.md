---
title: Master Workflow: Inversión Socialmente Responsable
version: 1.1
...
subcategory: General
tags: ['sri', 'esg-investing', 'sustainable-finance', 'impact-investing', 'ethical-finance', 'green-bonds', 'shareholder-activism', 'financial-ethics']
...
# 🚀 Estrategia de Automatización: Inversión Socialmente Responsable

Este documento define las tres vías posibles para implementar la skill de Inversión Socialmente Responsable en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Inversión Socialmente Responsable",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Inversión Socialmente Responsable"""
    print(f"Iniciando flujo técnico para: Inversión Socialmente Responsable")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Inversión Socialmente Responsable"}
...
**REST Endpoint:** `POST /v1/automate/349`
