---
title: Master Workflow: Estrategia de Salida (Exit)
version: 1.1
...
# 🚀 Estrategia de Automatización: Estrategia de Salida (Exit)

Este documento define las tres vías posibles para implementar la skill de Estrategia de Salida (Exit) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Estrategia de Salida (Exit)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Estrategia de Salida (Exit)"""
    print(f"Iniciando flujo técnico para: Estrategia de Salida (Exit)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Estrategia de Salida (Exit)"}
...
**REST Endpoint:** `POST /v1/automate/346`
