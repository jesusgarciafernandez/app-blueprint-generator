---
title: Master Workflow: Planificación Financiera
version: 1.1
...
subcategory: General
tags: ['fp-and-a', 'financial-cloning', 'budgeting', 'forecasting', 'burn-rate', 'financial-modeling', 'unit-economics']
...
# 🚀 Estrategia de Automatización: Planificación Financiera

Este documento define las tres vías posibles para implementar la skill de Planificación Financiera en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Planificación Financiera",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Planificación Financiera"""
    print(f"Iniciando flujo técnico para: Planificación Financiera")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Planificación Financiera"}
...
**REST Endpoint:** `POST /v1/automate/351`
