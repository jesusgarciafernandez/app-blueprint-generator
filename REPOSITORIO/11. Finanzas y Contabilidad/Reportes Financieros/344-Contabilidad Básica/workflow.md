---
title: Master Workflow: Contabilidad Básica
version: 1.1
...
subcategory: General
tags: ['accounting', 'bookkeeping', 'p&l', 'balance-sheet', 'cash-flow', 'financial-control', 'tax-compliance', 'auditing']
...
# 🚀 Estrategia de Automatización: Contabilidad Básica

Este documento define las tres vías posibles para implementar la skill de Contabilidad Básica en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Contabilidad Básica",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Contabilidad Básica"""
    print(f"Iniciando flujo técnico para: Contabilidad Básica")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Contabilidad Básica"}
...
**REST Endpoint:** `POST /v1/automate/344`
