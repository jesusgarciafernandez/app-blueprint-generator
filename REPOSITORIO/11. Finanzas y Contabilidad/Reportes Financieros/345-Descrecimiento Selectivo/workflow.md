---
title: Master Workflow: Descrecimiento Selectivo
version: 1.1
...
subcategory: General
tags: ['selective-degrowth', 'post-growth-economics', 'resource-optimization', 'sufficiency-strategy', 'circular-economy', 'wellbeing-economy', 'footprint-reduction', 'steady-state-economy']
...
# 🚀 Estrategia de Automatización: Descrecimiento Selectivo

Este documento define las tres vías posibles para implementar la skill de Descrecimiento Selectivo en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Descrecimiento Selectivo",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Descrecimiento Selectivo"""
    print(f"Iniciando flujo técnico para: Descrecimiento Selectivo")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Descrecimiento Selectivo"}
...
**REST Endpoint:** `POST /v1/automate/345`
