---
title: Master Workflow: Agente Contable Inteligente de Ingreso Dinámico
version: 1.1
...
subcategory: General
tags: [accounting, ocr, expenses, agent]
...
# 🚀 Estrategia de Automatización: Agente Contable Inteligente de Ingreso Dinámico

Este documento define las tres vías posibles para implementar la skill de Agente Contable Inteligente de Ingreso Dinámico en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Agente Contable Inteligente de Ingreso Dinámico",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Agente Contable Inteligente de Ingreso Dinámico"""
    print(f"Iniciando flujo técnico para: Agente Contable Inteligente de Ingreso Dinámico")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Agente Contable Inteligente de Ingreso Dinámico"}
...
**REST Endpoint:** `POST /v1/automate/334`
