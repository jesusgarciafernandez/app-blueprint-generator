---
title: Master Workflow: Gestión del Presupuesto
version: 1.1
...
subcategory: General
tags: ['budgeting', 'finance', 'cost-control', 'forecasting', 'roi', 'accounting', 'p&l', 'resource-allocation']
...
# 🚀 Estrategia de Automatización: Gestión del Presupuesto

Este documento define las tres vías posibles para implementar la skill de Gestión del Presupuesto en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión del Presupuesto",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión del Presupuesto"""
    print(f"Iniciando flujo técnico para: Gestión del Presupuesto")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión del Presupuesto"}
...
**REST Endpoint:** `POST /v1/automate/336`
