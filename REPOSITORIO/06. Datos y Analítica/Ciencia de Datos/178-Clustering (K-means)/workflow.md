---
title: Master Workflow: Clustering (K-means)
version: 1.1
...
# 🚀 Estrategia de Automatización: Clustering (K-means)

Este documento define las tres vías posibles para implementar la skill de Clustering (K-means) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Clustering (K-means)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Clustering (K-means)"""
    print(f"Iniciando flujo técnico para: Clustering (K-means)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Clustering (K-means)"}
...
**REST Endpoint:** `POST /v1/automate/178`
