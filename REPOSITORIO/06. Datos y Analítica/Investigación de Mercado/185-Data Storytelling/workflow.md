---
title: Master Workflow: Data Storytelling
version: 1.1
...
subcategory: General
tags: ['data-storytelling', 'data-viz', 'communication', 'business-intelligence', 'narrative', 'insights', 'persuasion', 'presentation-skills']
...
# 🚀 Estrategia de Automatización: Data Storytelling

Este documento define las tres vías posibles para implementar la skill de Data Storytelling en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Data Storytelling",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Data Storytelling"""
    print(f"Iniciando flujo técnico para: Data Storytelling")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Data Storytelling"}
...
**REST Endpoint:** `POST /v1/automate/185`
