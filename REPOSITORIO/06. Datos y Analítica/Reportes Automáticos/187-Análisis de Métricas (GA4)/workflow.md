---
title: Master Workflow: Análisis de Métricas (GA4)
version: 1.1
...
subcategory: General
tags: ['ga4', 'google-analytics', 'digital-analytics', 'tag-management', 'data-driven']
...
# 🚀 Estrategia de Automatización: Análisis de Métricas (GA4)

Este documento define las tres vías posibles para implementar la skill de Análisis de Métricas (GA4) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Análisis de Métricas (GA4)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Análisis de Métricas (GA4)"""
    print(f"Iniciando flujo técnico para: Análisis de Métricas (GA4)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Análisis de Métricas (GA4)"}
...
**REST Endpoint:** `POST /v1/automate/187`
