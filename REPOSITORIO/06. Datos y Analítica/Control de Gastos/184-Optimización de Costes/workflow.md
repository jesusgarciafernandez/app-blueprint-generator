---
title: Master Workflow: Optimización de Costes
version: 1.1
...
subcategory: General
tags: ['cost-optimization', 'opex-reduction', 'capex-efficiency', 'cost-center-analysis', 'budget-control', 'lean-management', 'finance-analytics', 'zero-based-budgeting']
...
# 🚀 Estrategia de Automatización: Optimización de Costes

Este documento define las tres vías posibles para implementar la skill de Optimización de Costes en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Optimización de Costes",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Optimización de Costes"""
    print(f"Iniciando flujo técnico para: Optimización de Costes")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Optimización de Costes"}
...
**REST Endpoint:** `POST /v1/automate/184`
