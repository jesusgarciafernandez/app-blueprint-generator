---
title: Master Workflow: Visualización de Datos (TableauD3)
version: 1.1
...
# 🚀 Estrategia de Automatización: Visualización de Datos (TableauD3)

Este documento define las tres vías posibles para implementar la skill de Visualización de Datos (TableauD3) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Visualización de Datos (TableauD3)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Visualización de Datos (TableauD3)"""
    print(f"Iniciando flujo técnico para: Visualización de Datos (TableauD3)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Visualización de Datos (TableauD3)"}
...
**REST Endpoint:** `POST /v1/automate/194`
