---
title: Master Workflow: Business Intelligence para Operaciones
version: 1.1
...
subcategory: General
tags: ['operational-bi', 'data-analytics', 'kpi-tracking', 'real-time-dashboards', 'process-optimization', 'data-driven-operations', 'power-bi', 'tableau']
...
# 🚀 Estrategia de Automatización: Business Intelligence para Operaciones

Este documento define las tres vías posibles para implementar la skill de Business Intelligence para Operaciones en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Business Intelligence para Operaciones",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Business Intelligence para Operaciones"""
    print(f"Iniciando flujo técnico para: Business Intelligence para Operaciones")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Business Intelligence para Operaciones"}
...
**REST Endpoint:** `POST /v1/automate/192`
