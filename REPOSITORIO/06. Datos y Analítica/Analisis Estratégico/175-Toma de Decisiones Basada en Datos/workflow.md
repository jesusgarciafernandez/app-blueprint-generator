---
title: Master Workflow: Toma de Decisiones Basada en Datos
version: 1.1
...
subcategory: General
tags: ['data-driven', 'analytics', 'decision-making', 'business-intelligence', 'bi', 'kpis', 'data-visualization', 'evidence-based']
...
# 🚀 Estrategia de Automatización: Toma de Decisiones Basada en Datos

Este documento define las tres vías posibles para implementar la skill de Toma de Decisiones Basada en Datos en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Toma de Decisiones Basada en Datos",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Toma de Decisiones Basada en Datos"""
    print(f"Iniciando flujo técnico para: Toma de Decisiones Basada en Datos")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Toma de Decisiones Basada en Datos"}
...
**REST Endpoint:** `POST /v1/automate/175`
