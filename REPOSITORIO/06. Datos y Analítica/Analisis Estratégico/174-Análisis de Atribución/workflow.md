---
title: Master Workflow: Análisis de Atribución
version: 1.1
...
# 🚀 Estrategia de Automatización: Análisis de Atribución

Este documento define las tres vías posibles para implementar la skill de Análisis de Atribución en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Análisis de Atribución",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Análisis de Atribución"""
    print(f"Iniciando flujo técnico para: Análisis de Atribución")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Análisis de Atribución"}
...
**REST Endpoint:** `POST /v1/automate/174`
