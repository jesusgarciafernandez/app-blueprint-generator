---
title: Master Workflow: Big Data (HadoopSpark)
version: 1.1
...
# 🚀 Estrategia de Automatización: Big Data (HadoopSpark)

Este documento define las tres vías posibles para implementar la skill de Big Data (HadoopSpark) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Big Data (HadoopSpark)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Big Data (HadoopSpark)"""
    print(f"Iniciando flujo técnico para: Big Data (HadoopSpark)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Big Data (HadoopSpark)"}
...
**REST Endpoint:** `POST /v1/automate/188`
