---
title: Master Workflow: Data Engineering
version: 1.1
...
subcategory: General
tags: ['data-engineering', 'etl', 'elt', 'pipelines', 'big-data', 'spark', 'airflow', 'data-warehouse', 'data-lake', 'sql', 'python']
...
# 🚀 Estrategia de Automatización: Data Engineering

Este documento define las tres vías posibles para implementar la skill de Data Engineering en cualquier aplicación del ecosistema Antigravity.
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Data Engineering"""
    print(f"Iniciando flujo técnico para: Data Engineering")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Data Engineering"}
...
**REST Endpoint:** `POST /v1/automate/189`
