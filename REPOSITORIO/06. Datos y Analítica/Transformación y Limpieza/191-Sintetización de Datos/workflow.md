---
title: Master Workflow: Sintetización de Datos
version: 1.1
...
# 🚀 Estrategia de Automatización: Sintetización de Datos

Este documento define las tres vías posibles para implementar la skill de Sintetización de Datos en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Sintetización de Datos",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Sintetización de Datos"""
    print(f"Iniciando flujo técnico para: Sintetización de Datos")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Sintetización de Datos"}
...
**REST Endpoint:** `POST /v1/automate/191`
