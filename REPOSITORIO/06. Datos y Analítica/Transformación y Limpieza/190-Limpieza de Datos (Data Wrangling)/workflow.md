---
title: Master Workflow: Limpieza de Datos (Data Wrangling)
version: 1.1
...
subcategory: General
tags: ['data-wrangling', 'data-cleaning', 'pandas', 'etl', 'data-integrity', 'regex', 'deduplication', 'outliers']
...
# 🚀 Estrategia de Automatización: Limpieza de Datos (Data Wrangling)

Este documento define las tres vías posibles para implementar la skill de Limpieza de Datos (Data Wrangling) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Limpieza de Datos (Data Wrangling)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Limpieza de Datos (Data Wrangling)"""
    print(f"Iniciando flujo técnico para: Limpieza de Datos (Data Wrangling)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Limpieza de Datos (Data Wrangling)"}
...
**REST Endpoint:** `POST /v1/automate/190`
