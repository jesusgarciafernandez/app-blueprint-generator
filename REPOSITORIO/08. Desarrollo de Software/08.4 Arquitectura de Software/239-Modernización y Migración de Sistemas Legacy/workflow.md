---
title: Master Workflow: Modernización y Migración de Sistemas Legacy
version: 1.1
...
# 🚀 Estrategia de Automatización: Modernización y Migración de Sistemas Legacy

Este documento define las tres vías posibles para implementar la skill de Modernización y Migración de Sistemas Legacy en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Modernización y Migración de Sistemas Legacy",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Modernización y Migración de Sistemas Legacy"""
    print(f"Iniciando flujo técnico para: Modernización y Migración de Sistemas Legacy")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Modernización y Migración de Sistemas Legacy"}
...
**REST Endpoint:** `POST /v1/automate/239`
