---
title: Master Workflow: Resiliencia Comunitaria
version: 1.1
...
subcategory: General
tags: ['community-resilience', 'local-empowerment', 'crisis-management', 'social-capital', 'disaster-preparedness', 'mutual-aid', 'neighborhood-tech', 'collaborative-maintenance']
...
# 🚀 Estrategia de Automatización: Resiliencia Comunitaria

Este documento define las tres vías posibles para implementar la skill de Resiliencia Comunitaria en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Resiliencia Comunitaria",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Resiliencia Comunitaria"""
    print(f"Iniciando flujo técnico para: Resiliencia Comunitaria")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Resiliencia Comunitaria"}
...
**REST Endpoint:** `POST /v1/automate/496`
