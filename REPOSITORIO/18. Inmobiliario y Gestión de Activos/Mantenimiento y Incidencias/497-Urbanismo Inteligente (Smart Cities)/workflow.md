---
title: Master Workflow: Urbanismo Inteligente (Smart Cities)
version: 1.1
...
subcategory: General
tags: ['smart-cities', 'iot-urban', 'urban-data-analytics', 'digital-twin', 'intelligent-transportation', 'smart-grid', 'urban-resilience', 'citizens-as-sensors']
...
# 🚀 Estrategia de Automatización: Urbanismo Inteligente (Smart Cities)

Este documento define las tres vías posibles para implementar la skill de Urbanismo Inteligente (Smart Cities) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Urbanismo Inteligente (Smart Cities)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Urbanismo Inteligente (Smart Cities)"""
    print(f"Iniciando flujo técnico para: Urbanismo Inteligente (Smart Cities)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Urbanismo Inteligente (Smart Cities)"}
...
**REST Endpoint:** `POST /v1/automate/497`
