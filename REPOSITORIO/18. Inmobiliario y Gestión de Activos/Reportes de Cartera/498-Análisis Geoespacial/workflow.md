---
title: Master Workflow: Análisis Geoespacial
version: 1.1
...
subcategory: General
tags: ['gis', 'geospatial-analysis', 'qgis', 'postgis', 'cartography', 'spatial-data', 'lidar', 'remote-sensing', 'location-intelligence']
...
# 🚀 Estrategia de Automatización: Análisis Geoespacial

Este documento define las tres vías posibles para implementar la skill de Análisis Geoespacial en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Análisis Geoespacial",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Análisis Geoespacial"""
    print(f"Iniciando flujo técnico para: Análisis Geoespacial")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Análisis Geoespacial"}
...
**REST Endpoint:** `POST /v1/automate/498`
