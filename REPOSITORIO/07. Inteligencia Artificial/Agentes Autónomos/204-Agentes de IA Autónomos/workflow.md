---
title: Master Workflow: Agentes de IA Autónomos
version: 1.1
...
subcategory: General
tags: ['autonomous-agents', 'autogen', 'langchain-agents', 'rewoo', 'react-pattern', 'multi-agent-systems', 'tool-augmented-generation', 'ai-reasoning']
...
# 🚀 Estrategia de Automatización: Agentes de IA Autónomos

Este documento define las tres vías posibles para implementar la skill de Agentes de IA Autónomos en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Agentes de IA Autónomos",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Agentes de IA Autónomos"""
    print(f"Iniciando flujo técnico para: Agentes de IA Autónomos")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Agentes de IA Autónomos"}
...
**REST Endpoint:** `POST /v1/automate/204`
