---
title: Master Workflow: Explicabilidad de la IA (XAI)
version: 1.1
...
# 🚀 Estrategia de Automatización: Explicabilidad de la IA (XAI)

Este documento define las tres vías posibles para implementar la skill de Explicabilidad de la IA (XAI) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Explicabilidad de la IA (XAI)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Explicabilidad de la IA (XAI)"""
    print(f"Iniciando flujo técnico para: Explicabilidad de la IA (XAI)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Explicabilidad de la IA (XAI)"}
...
**REST Endpoint:** `POST /v1/automate/207`
