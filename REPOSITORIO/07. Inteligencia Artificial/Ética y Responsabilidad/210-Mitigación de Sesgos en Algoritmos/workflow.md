---
title: Master Workflow: Mitigación de Sesgos en Algoritmos
version: 1.1
...
# 🚀 Estrategia de Automatización: Mitigación de Sesgos en Algoritmos

Este documento define las tres vías posibles para implementar la skill de Mitigación de Sesgos en Algoritmos en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Mitigación de Sesgos en Algoritmos",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Mitigación de Sesgos en Algoritmos"""
    print(f"Iniciando flujo técnico para: Mitigación de Sesgos en Algoritmos")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Mitigación de Sesgos en Algoritmos"}
...
**REST Endpoint:** `POST /v1/automate/210`
