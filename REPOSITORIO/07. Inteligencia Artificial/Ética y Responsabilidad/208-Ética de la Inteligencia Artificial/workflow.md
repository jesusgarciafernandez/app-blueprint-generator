---
title: Master Workflow: Ética de la Inteligencia Artificial
version: 1.1
...
subcategory: General
tags: ['ai-ethics', 'responsible-ai', 'alignment-problem', 'algorithmic-accountability', 'ai-governance', 'transparency', 'ethical-ai-frameworks', 'autonomous-systems']
...
# 🚀 Estrategia de Automatización: Ética de la Inteligencia Artificial

Este documento define las tres vías posibles para implementar la skill de Ética de la Inteligencia Artificial en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Ética de la Inteligencia Artificial",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Ética de la Inteligencia Artificial"""
    print(f"Iniciando flujo técnico para: Ética de la Inteligencia Artificial")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Ética de la Inteligencia Artificial"}
...
**REST Endpoint:** `POST /v1/automate/208`
