---
title: Master Workflow: Prompt Engineering
version: 1.1
...
# 🚀 Estrategia de Automatización: Prompt Engineering

Este documento define las tres vías posibles para implementar la skill de Prompt Engineering en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Prompt Engineering",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Prompt Engineering"""
    print(f"Iniciando flujo técnico para: Prompt Engineering")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Prompt Engineering"}
...
**REST Endpoint:** `POST /v1/automate/222`
