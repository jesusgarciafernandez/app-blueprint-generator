---
title: Master Workflow: Orquestación Multi-Agente mediante CrewAI
version: 1.1
...
tags: [ia, agentes, crewai, orquestación, flujos, equipos-digitales]
...
# 🚀 Estrategia de Automatización: Orquestación Multi-Agente mediante CrewAI

Este documento define las tres vías posibles para implementar la skill de Orquestación Multi-Agente mediante CrewAI en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Orquestación Multi-Agente mediante CrewAI",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Orquestación Multi-Agente mediante CrewAI"""
    print(f"Iniciando flujo técnico para: Orquestación Multi-Agente mediante CrewAI")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Orquestación Multi-Agente mediante CrewAI"}
...
**REST Endpoint:** `POST /v1/automate/201`
