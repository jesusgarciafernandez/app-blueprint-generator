---
title: Master Workflow: Gestión de Carteras de Agentes IA (AgentFolio)
version: 1.1
...
tags: [ia, agentes, agentfolio, cartera, productividad, activos-digitales]
...
# 🚀 Estrategia de Automatización: Gestión de Carteras de Agentes IA (AgentFolio)

Este documento define las tres vías posibles para implementar la skill de Gestión de Carteras de Agentes IA (AgentFolio) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de Carteras de Agentes IA (AgentFolio)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de Carteras de Agentes IA (AgentFolio)"""
    print(f"Iniciando flujo técnico para: Gestión de Carteras de Agentes IA (AgentFolio)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de Carteras de Agentes IA (AgentFolio)"}
...
**REST Endpoint:** `POST /v1/automate/200`
