---
title: Master Workflow: Delegación Estratégica en Sistemas Multi-Agente (Swarm)
version: 1.1
...
tags: [multi-agente, swarm, delegación, paralelismo, automatización, IA]
...
# 🚀 Estrategia de Automatización: Delegación Estratégica en Sistemas Multi-Agente (Swarm)

Este documento define las tres vías posibles para implementar la skill de Delegación Estratégica en Sistemas Multi-Agente (Swarm) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Delegación Estratégica en Sistemas Multi-Agente (Swarm)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Delegación Estratégica en Sistemas Multi-Agente (Swarm)"""
    print(f"Iniciando flujo técnico para: Delegación Estratégica en Sistemas Multi-Agente (Swarm)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Delegación Estratégica en Sistemas Multi-Agente (Swarm)"}
...
**REST Endpoint:** `POST /v1/automate/199`
