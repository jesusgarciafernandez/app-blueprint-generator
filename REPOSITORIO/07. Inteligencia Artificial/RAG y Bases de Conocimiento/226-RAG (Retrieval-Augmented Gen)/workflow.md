---
title: Master Workflow: RAG (Retrieval-Augmented Gen)
version: 1.1
...
# 🚀 Estrategia de Automatización: RAG (Retrieval-Augmented Gen)

Este documento define las tres vías posibles para implementar la skill de RAG (Retrieval-Augmented Gen) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "RAG (Retrieval-Augmented Gen)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de RAG (Retrieval-Augmented Gen)"""
    print(f"Iniciando flujo técnico para: RAG (Retrieval-Augmented Gen)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "RAG (Retrieval-Augmented Gen)"}
...
**REST Endpoint:** `POST /v1/automate/226`
