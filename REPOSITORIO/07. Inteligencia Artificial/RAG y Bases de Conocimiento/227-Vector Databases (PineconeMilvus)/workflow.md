---
title: Master Workflow: Vector Databases (PineconeMilvus)
version: 1.1
...
subcategory: General
tags: ['vector-databases', 'pinecone', 'milvus', 'weaviate', 'chroma', 'embeddings', 'semantic-search', 'rag']
...
# 🚀 Estrategia de Automatización: Vector Databases (PineconeMilvus)

Este documento define las tres vías posibles para implementar la skill de Vector Databases (PineconeMilvus) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Vector Databases (PineconeMilvus)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Vector Databases (PineconeMilvus)"""
    print(f"Iniciando flujo técnico para: Vector Databases (PineconeMilvus)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Vector Databases (PineconeMilvus)"}
...
**REST Endpoint:** `POST /v1/automate/227`
