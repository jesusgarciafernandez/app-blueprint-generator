---
title: Master Workflow: Visión por Computadora
version: 1.1
...
# 🚀 Estrategia de Automatización: Visión por Computadora

Este documento define las tres vías posibles para implementar la skill de Visión por Computadora en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Visión por Computadora",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Visión por Computadora"""
    print(f"Iniciando flujo técnico para: Visión por Computadora")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Visión por Computadora"}
...
**REST Endpoint:** `POST /v1/automate/230`
