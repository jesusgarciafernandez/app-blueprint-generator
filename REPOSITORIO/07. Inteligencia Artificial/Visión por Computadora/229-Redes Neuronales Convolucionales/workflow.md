---
title: Master Workflow: Redes Neuronales Convolucionales
version: 1.1
...
subcategory: General
tags: ['cnn', 'computer-vision', 'deep-learning', 'image-recognition', 'convolutional-layers', 'pooling', 'transfer-learning', 'pytorch', 'tensorflow']
...
# 🚀 Estrategia de Automatización: Redes Neuronales Convolucionales

Este documento define las tres vías posibles para implementar la skill de Redes Neuronales Convolucionales en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Redes Neuronales Convolucionales",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Redes Neuronales Convolucionales"""
    print(f"Iniciando flujo técnico para: Redes Neuronales Convolucionales")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Redes Neuronales Convolucionales"}
...
**REST Endpoint:** `POST /v1/automate/229`
