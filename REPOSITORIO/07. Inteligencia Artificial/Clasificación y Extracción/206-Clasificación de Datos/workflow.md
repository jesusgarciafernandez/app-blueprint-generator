---
title: Master Workflow: Clasificación de Datos
version: 1.1
...
subcategory: General
tags: ['data-classification', 'taxonomy', 'metadata', 'unstructured-data', 'nlp', 'content-tagging', 'knowledge-organization']
...
# 🚀 Estrategia de Automatización: Clasificación de Datos

Este documento define las tres vías posibles para implementar la skill de Clasificación de Datos en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Clasificación de Datos",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Clasificación de Datos"""
    print(f"Iniciando flujo técnico para: Clasificación de Datos")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Clasificación de Datos"}
...
**REST Endpoint:** `POST /v1/automate/206`
