---
title: Master Workflow: Gestión de Ventana de Contexto y Optimización LLM
version: 1.1
...
tags: [ia, tokens, contexto, llm, optimización, eficiencia, agéntica]
...
# 🚀 Estrategia de Automatización: Gestión de Ventana de Contexto y Optimización LLM

Este documento define las tres vías posibles para implementar la skill de Gestión de Ventana de Contexto y Optimización LLM en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de Ventana de Contexto y Optimización LLM",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de Ventana de Contexto y Optimización LLM"""
    print(f"Iniciando flujo técnico para: Gestión de Ventana de Contexto y Optimización LLM")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de Ventana de Contexto y Optimización LLM"}
...
**REST Endpoint:** `POST /v1/automate/195`
