---
title: Master Workflow: Aprendizaje por Refuerzo
version: 1.1
...
subcategory: General
tags: ['reinforcement-learning', 'rlhf', 'agent', 'gymnasium', 'stable-baselines', 'q-learning', 'policy-gradient', 'autonomous-systems']
...
# 🚀 Estrategia de Automatización: Aprendizaje por Refuerzo

Este documento define las tres vías posibles para implementar la skill de Aprendizaje por Refuerzo en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Aprendizaje por Refuerzo",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Aprendizaje por Refuerzo"""
    print(f"Iniciando flujo técnico para: Aprendizaje por Refuerzo")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Aprendizaje por Refuerzo"}
...
**REST Endpoint:** `POST /v1/automate/211`
