---
title: Master Workflow: Delegación de Tareas Personales
version: 1.1
...
subcategory: General
tags: ['delegation', 'virtual-assistance', 'outsourcing', 'process-mapping', 'leadership', 'team-management', 'ai-agents']
...
# 🚀 Estrategia de Automatización: Delegación de Tareas Personales

Este documento define las tres vías posibles para implementar la skill de Delegación de Tareas Personales en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Delegación de Tareas Personales",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Delegación de Tareas Personales"""
    print(f"Iniciando flujo técnico para: Delegación de Tareas Personales")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Delegación de Tareas Personales"}
...
**REST Endpoint:** `POST /v1/automate/250`
