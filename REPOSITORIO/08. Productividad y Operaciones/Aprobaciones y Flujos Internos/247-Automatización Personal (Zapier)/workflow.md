---
title: Master Workflow: Automatización Personal (Zapier)
version: 1.1
...
subcategory: General
tags: ['automation', 'zapier', 'make-com', 'n8n', 'low-code', 'workflow-optimization', 'api-integration']
...
# 🚀 Estrategia de Automatización: Automatización Personal (Zapier)

Este documento define las tres vías posibles para implementar la skill de Automatización Personal (Zapier) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Automatización Personal (Zapier)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Automatización Personal (Zapier)"""
    print(f"Iniciando flujo técnico para: Automatización Personal (Zapier)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Automatización Personal (Zapier)"}
...
**REST Endpoint:** `POST /v1/automate/247`
