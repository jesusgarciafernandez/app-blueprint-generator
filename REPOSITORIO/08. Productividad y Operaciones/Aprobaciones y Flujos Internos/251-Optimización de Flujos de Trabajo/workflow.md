---
title: Master Workflow: Optimización de Flujos de Trabajo
version: 1.1
...
subcategory: General
tags: ['workflow-optimization', 'process-improvement', 'lean', 'six-sigma', 'bottleneck-analysis', 'automation', 'productivity', 'value-stream-mapping']
...
# 🚀 Estrategia de Automatización: Optimización de Flujos de Trabajo

Este documento define las tres vías posibles para implementar la skill de Optimización de Flujos de Trabajo en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Optimización de Flujos de Trabajo",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Optimización de Flujos de Trabajo"""
    print(f"Iniciando flujo técnico para: Optimización de Flujos de Trabajo")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Optimización de Flujos de Trabajo"}
...
**REST Endpoint:** `POST /v1/automate/251`
