---
title: Master Workflow: Automatización de Procesos (RPA)
version: 1.1
...
subcategory: General
tags: ['rpa', 'automation', 'uipath', 'power-automate', 'workflow-efficiency', 'bot-training', 'optical-character-recognition']
...
# 🚀 Estrategia de Automatización: Automatización de Procesos (RPA)

Este documento define las tres vías posibles para implementar la skill de Automatización de Procesos (RPA) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Automatización de Procesos (RPA)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Automatización de Procesos (RPA)"""
    print(f"Iniciando flujo técnico para: Automatización de Procesos (RPA)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Automatización de Procesos (RPA)"}
...
**REST Endpoint:** `POST /v1/automate/248`
