---
title: Master Workflow: Business Process Reengineering
version: 1.1
...
subcategory: General
tags: ['bpr', 'process-reengineering', 'radical-change', 'operational-excellence', 'digital-transformation', 'business-architecture', 'automation', 'efficiency']
...
# 🚀 Estrategia de Automatización: Business Process Reengineering

Este documento define las tres vías posibles para implementar la skill de Business Process Reengineering en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Business Process Reengineering",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Business Process Reengineering"""
    print(f"Iniciando flujo técnico para: Business Process Reengineering")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Business Process Reengineering"}
...
**REST Endpoint:** `POST /v1/automate/249`
