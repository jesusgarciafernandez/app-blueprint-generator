---
title: Master Workflow: Gestión de Correo (Inbox Zero)
version: 1.1
...
subcategory: General
tags: ['email-management', 'inbox-zero', 'merlin-mann', 'productivity', 'attention-management', 'workflow-efficiency']
...
# 🚀 Estrategia de Automatización: Gestión de Correo (Inbox Zero)

Este documento define las tres vías posibles para implementar la skill de Gestión de Correo (Inbox Zero) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de Correo (Inbox Zero)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de Correo (Inbox Zero)"""
    print(f"Iniciando flujo técnico para: Gestión de Correo (Inbox Zero)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de Correo (Inbox Zero)"}
...
**REST Endpoint:** `POST /v1/automate/274`
