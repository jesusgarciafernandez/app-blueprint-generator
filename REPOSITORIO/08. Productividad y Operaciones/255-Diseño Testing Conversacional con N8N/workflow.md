---
title: Master Workflow: Diseño Testing Conversacional con N8N
version: 1.1
...
subcategory: General
tags: [n8n, testing, sandbox, agent]
...
# 🚀 Estrategia de Automatización: Diseño Testing Conversacional con N8N

Este documento define las tres vías posibles para implementar la skill de Diseño Testing Conversacional con N8N en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Diseño Testing Conversacional con N8N",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Diseño Testing Conversacional con N8N"""
    print(f"Iniciando flujo técnico para: Diseño Testing Conversacional con N8N")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Diseño Testing Conversacional con N8N"}
...
**REST Endpoint:** `POST /v1/automate/255`
