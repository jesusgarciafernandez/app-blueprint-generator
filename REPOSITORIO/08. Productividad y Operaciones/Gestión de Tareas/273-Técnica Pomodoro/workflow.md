---
title: Master Workflow: Técnica Pomodoro
version: 1.1
...
subcategory: General
tags: ['pomodoro', 'time-boxing', 'focus', 'flow-state', 'sprints', 'rest-management', 'productivity-rituals']
...
# 🚀 Estrategia de Automatización: Técnica Pomodoro

Este documento define las tres vías posibles para implementar la skill de Técnica Pomodoro en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Técnica Pomodoro",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Técnica Pomodoro"""
    print(f"Iniciando flujo técnico para: Técnica Pomodoro")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Técnica Pomodoro"}
...
**REST Endpoint:** `POST /v1/automate/273`
