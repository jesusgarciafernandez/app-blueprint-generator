---
title: Master Workflow: Gestión de la Atención
version: 1.1
...
subcategory: General
tags: ['attention-management', 'deep-work', 'cal-newport', 'focus', 'anti-multitasking', 'cognitive-capacity', 'flow-state']
...
# 🚀 Estrategia de Automatización: Gestión de la Atención

Este documento define las tres vías posibles para implementar la skill de Gestión de la Atención en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de la Atención",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de la Atención"""
    print(f"Iniciando flujo técnico para: Gestión de la Atención")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de la Atención"}
...
**REST Endpoint:** `POST /v1/automate/268`
