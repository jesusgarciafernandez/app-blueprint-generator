---
title: Master Workflow: Priorización (Matriz Eisenhower)
version: 1.1
...
subcategory: General
tags: ['eisenhower-matrix', 'prioritization', 'effective-management', 'stephen-covey', 'urgent-important', 'decision-making', 'productivity']
...
# 🚀 Estrategia de Automatización: Priorización (Matriz Eisenhower)

Este documento define las tres vías posibles para implementar la skill de Priorización (Matriz Eisenhower) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Priorización (Matriz Eisenhower)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Priorización (Matriz Eisenhower)"""
    print(f"Iniciando flujo técnico para: Priorización (Matriz Eisenhower)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Priorización (Matriz Eisenhower)"}
...
**REST Endpoint:** `POST /v1/automate/271`
