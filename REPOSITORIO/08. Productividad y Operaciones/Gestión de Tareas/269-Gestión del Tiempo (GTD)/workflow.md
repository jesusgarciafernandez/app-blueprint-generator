---
title: Master Workflow: Gestión del Tiempo (GTD)
version: 1.1
...
subcategory: General
tags: ['gtd', 'getting-things-done', 'david-allen', 'productivity', 'time-management', 'mental-clarity', 'task-organization']
...
# 🚀 Estrategia de Automatización: Gestión del Tiempo (GTD)

Este documento define las tres vías posibles para implementar la skill de Gestión del Tiempo (GTD) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión del Tiempo (GTD)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión del Tiempo (GTD)"""
    print(f"Iniciando flujo técnico para: Gestión del Tiempo (GTD)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión del Tiempo (GTD)"}
...
**REST Endpoint:** `POST /v1/automate/269`
