---
title: Master Workflow: Revisión Semanal (Weekly Review)
version: 1.1
...
subcategory: General
tags: ['weekly-review', 'gtd', 'planning', 'productivity-rituals', 'self-reflection', 'continuous-improvement', 'alignment']
...
# 🚀 Estrategia de Automatización: Revisión Semanal (Weekly Review)

Este documento define las tres vías posibles para implementar la skill de Revisión Semanal (Weekly Review) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Revisión Semanal (Weekly Review)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Revisión Semanal (Weekly Review)"""
    print(f"Iniciando flujo técnico para: Revisión Semanal (Weekly Review)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Revisión Semanal (Weekly Review)"}
...
**REST Endpoint:** `POST /v1/automate/272`
