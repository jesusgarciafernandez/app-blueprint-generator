---
title: Master Workflow: Gestión de Tareas (TodoistJira)
version: 1.1
...
subcategory: General
tags: ['todoist', 'jira', 'linear', 'task-management', 'agile', 'prioritization', 'scrum', 'kanban']
...
# 🚀 Estrategia de Automatización: Gestión de Tareas (TodoistJira)

Este documento define las tres vías posibles para implementar la skill de Gestión de Tareas (TodoistJira) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de Tareas (TodoistJira)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de Tareas (TodoistJira)"""
    print(f"Iniciando flujo técnico para: Gestión de Tareas (TodoistJira)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de Tareas (TodoistJira)"}
...
**REST Endpoint:** `POST /v1/automate/266`
