---
title: Master Workflow: Pensamiento Visual (Visual Thinking)
version: 1.1
...
subcategory: General
tags: ['visual-thinking', 'sketchnoting', 'graphic-facilitation', 'problem-solving', 'strategy-mapping', 'cognitive-organization']
...
# 🚀 Estrategia de Automatización: Pensamiento Visual (Visual Thinking)

Este documento define las tres vías posibles para implementar la skill de Pensamiento Visual (Visual Thinking) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Pensamiento Visual (Visual Thinking)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Pensamiento Visual (Visual Thinking)"""
    print(f"Iniciando flujo técnico para: Pensamiento Visual (Visual Thinking)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Pensamiento Visual (Visual Thinking)"}
...
**REST Endpoint:** `POST /v1/automate/257`
