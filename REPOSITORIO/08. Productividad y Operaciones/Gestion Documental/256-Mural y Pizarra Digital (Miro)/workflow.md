---
title: Master Workflow: Mural y Pizarra Digital (Miro)
version: 1.1
...
subcategory: General
tags: ['miro', 'mural', 'visual-collaboration', 'remote-work', 'design-thinking', 'agile', 'workshop-facilitation']
...
# 🚀 Estrategia de Automatización: Mural y Pizarra Digital (Miro)

Este documento define las tres vías posibles para implementar la skill de Mural y Pizarra Digital (Miro) en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Mural y Pizarra Digital (Miro)",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Mural y Pizarra Digital (Miro)"""
    print(f"Iniciando flujo técnico para: Mural y Pizarra Digital (Miro)")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Mural y Pizarra Digital (Miro)"}
...
**REST Endpoint:** `POST /v1/automate/256`
