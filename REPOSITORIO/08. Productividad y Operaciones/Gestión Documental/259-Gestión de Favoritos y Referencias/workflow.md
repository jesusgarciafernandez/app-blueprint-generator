---
title: Master Workflow: Gestión de Favoritos y Referencias
version: 1.1
...
subcategory: General
tags: ['pkm', 'bookmark-management', 'information-architecture', 'curation', 'digital-garden', 'web-clipping', 'zettelkasten']
...
# 🚀 Estrategia de Automatización: Gestión de Favoritos y Referencias

Este documento define las tres vías posibles para implementar la skill de Gestión de Favoritos y Referencias en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Gestión de Favoritos y Referencias",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Gestión de Favoritos y Referencias"""
    print(f"Iniciando flujo técnico para: Gestión de Favoritos y Referencias")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Gestión de Favoritos y Referencias"}
...
**REST Endpoint:** `POST /v1/automate/259`
