---
title: Master Workflow: Minimalismo Digital
version: 1.1
...
subcategory: General
tags: ['digital-minimalism', 'intentional-technology', 'focus-economy', 'attention-management', 'tech-detox', 'productivity-optimization', 'digital-wellbeing', 'information-reduction']
...
# 🚀 Estrategia de Automatización: Minimalismo Digital

Este documento define las tres vías posibles para implementar la skill de Minimalismo Digital en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Minimalismo Digital",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Minimalismo Digital"""
    print(f"Iniciando flujo técnico para: Minimalismo Digital")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Minimalismo Digital"}
...
**REST Endpoint:** `POST /v1/automate/261`
