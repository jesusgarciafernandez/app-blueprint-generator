---
title: Master Workflow: Automatización Web RPA Scraping Activo
version: 1.1
...
subcategory: General
tags: [rpa, scraping, automation, web]
...
# 🚀 Estrategia de Automatización: Automatización Web RPA Scraping Activo

Este documento define las tres vías posibles para implementar la skill de Automatización Web RPA Scraping Activo en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Automatización Web RPA Scraping Activo",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Automatización Web RPA Scraping Activo"""
    print(f"Iniciando flujo técnico para: Automatización Web RPA Scraping Activo")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Automatización Web RPA Scraping Activo"}
...
**REST Endpoint:** `POST /v1/automate/252`
