---
title: Master Workflow: Resumen de Reuniones Automático
version: 1.1
...
subcategory: General
tags: ['ai-summarization', 'asr-technology', 'meeting-notes', 'action-items', 'workflow-automation', 'transcription', 'corporate-efficiency']
...
# 🚀 Estrategia de Automatización: Resumen de Reuniones Automático

Este documento define las tres vías posibles para implementar la skill de Resumen de Reuniones Automático en cualquier aplicación del ecosistema Antigravity.
...
```json
{
  ...
  "skill_target": "Resumen de Reuniones Automático",
...
def execute_skill_automation(input_params):
    """Lógica operativa automatizada de Resumen de Reuniones Automático"""
    print(f"Iniciando flujo técnico para: Resumen de Reuniones Automático")
    # TODO: Implementar lógica basada en SKILL.md
    return {"status": "success", "skill": "Resumen de Reuniones Automático"}
...
**REST Endpoint:** `POST /v1/automate/254`
